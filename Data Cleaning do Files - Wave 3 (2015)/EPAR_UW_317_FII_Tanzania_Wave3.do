...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Tanzania Financial Inclusion Insights Wave 3 data set.
...
*After downloading the "FSP_Final_Tanzania_W3 (public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data\FSP_Final_Tanzania_W3 (public).xlsx", firstrow clear
save "filepath for location where you want to save dta file/Tanzania_Wave3_Stata.dta", replace
clear
...
*Tanzania*
*******
use "$input\Tanzania_Wave3_Stata.dta"
...
//Location Variables
rename AA1 region
la var region "residential region of respondent (AA1)" //refer to codebook for labels
rename AA2 district
la var district "residential district of respondent" //refer to codebook for labels
rename AA4 urban_rural //1=urban, 2=rural
la var urban_rural "settlement size(AA4)"
...
//44 missing ages listed as 999; replace 999 with missing
...
rename DG4 highest_ed //Refer to codebook for labels
...
la var sim_access "person uses sim card belonging to someone else (MT15)" //Ask only if does not own a SIM

rename FF1 bank_own
la var bank_own "person has bank account registered in their name (FF1)"
rename FF3 reason_nobankacct 
la var reason_nobankacct "reason person does not have bank account (see codebook for labels) (FF3)"
...
rename MM12 dfs_reasonnouse //refer to FII codebook for labels
la var dfs_reasonnouse "reason person has never used DFS (MM12)"
...
rename MM13 dfs_reasonnoreg //refer to FII codebook for labels
la var dfs_reasonnoreg "reason person has not registered, despite using DFS (MM13)"
...
rename MM14	dfs_reasonstart //refer to FII codebook for labels
la var dfs_reasonstart "reason person started using DFS (MM14)"
...
la var dfs_paytv "person has used DFS to pay a TV/cable/satellite bill (MM17_9)"
...
la var dfs_recfam_reg "person has used DFS to receive money from fam/friends for reg support or emergency (MM15_12)"
rename MM15_13 dfs_recgov_welfpen
la var dfs_recgov_welfpen "person has used DFS to receive welfare or pension or other benefit from gov (MM15_13)"
rename MM15_14 dfs_recwage1
la var dfs_recwage1 "person has used DFS to receive wages from primary or secondary job (MM15_14)"
rename MM15_15 dfs_paylarge
la var dfs_paylarge "person has used DFS to pay for large acquisitions (MM15_19)"
rename MM15_16 dfs_payins
la var dfs_payins "person has used DFS to make insurance pmts (MM15_20)"
rename MM15_17 dfs_takeloan
la var dfs_takeloan "person has used DFS to take a loan, make payment on loan (MM15_17)"
rename MM15_18 dfs_savepurchase
la var dfs_savepurchase "person has used DFS to save for future purchases or payment (MM15_18)"
rename MM15_19 dfs_savepen
la var dfs_savepen "person has used DFS to save for pension (MM15_19)"
rename MM15_20 dfs_saveunknown
la var dfs_saveunknown "person has used DFS to set aside money just in case, undetermined purpose (MM15_20)"
rename MM15_21 dfs_invest
la var dfs_invest "person has used DFS to invest, buy stock or shares (MM15_21)"
...
la var dfs_savings "person has used DFS to receive money from a savings or lending group (MM15_26)"
rename MM15_27 dfs_rent
la var dfs_rent "person has used DFS to spay rent (MM15_27)"
rename MM15_28 dfs_maint
la var dfs_savings "person has used DFS for account maintenance (MM15_28)"
rename MM15_29 dfs_other
la var dfs_other "person has used DFS for other purpose (MM15_29)"
...
la var dfs_agentsame_reason "reason person uses same MM agent regularly (see codebook for labels) (MM34)"
...
rename MM40_1 dfs_agentiss_absent
la var dfs_agentiss_absent "agent issue: agent was absent (MM40_1)"
rename MM40_2 dfs_agentiss_rude
la var dfs_agentiss_rude "agent issue: agent was rude (MM40_2)"
rename MM40_3 dfs_agentiss_nocash
la var dfs_agentiss_nocash "agent issue: agent didn't have enough cash or e-float (MM40_3)"
rename MM40_4 dfs_agentiss_refuse
la var dfs_agentiss_refuse "agent issue: agent refused to perform transaction (MM40_4)"
rename MM40_5 dfs_agentiss_noknow
la var dfs_agentiss_noknow "agent issue: agent didn't know how to perform trans (MM40_5)"
rename MM40_6 dfs_agentiss_overcharge
la var dfs_agentiss_overcharge "agent issue: agent overchareged or asked for deposit (MM40_6)"
rename MM40_7 dfs_agentiss_wrongcash
la var dfs_agentiss_wrongcash "agent issue: agent didn't give all cash owed (MM40_7)"
rename MM40_8 dfs_agentiss_netdown
la var dfs_agentiss_netdown "agent issue: GSM or mobile network down (MM40_8)"
rename MM40_9 dfs_agentiss_agsysdown
la var dfs_agentiss_agsysdown "agent issue: agent system down (MM40_9)"
rename MM40_10 dfs_agentiss_notime
la var dfs_agentiss_notime "agent issue: transaction too time consuming (MM40_10)"
rename MM40_11 dfs_agentiss_noreceipt
la var dfs_agentiss_noreceipt "agent issue: didn't get receipt (MM40_11)"
rename MM40_12 dfs_agentiss_chargedep
la var dfs_agentiss_chargedep "agent issue: agent charged for depositing money (MM40_12)"
rename MM40_13 dfs_agentiss_pin
la var dfs_agentiss_pin "agent issue: agent asked for PIN (MM40_13)"
rename MM40_14 dfs_agentiss_women
la var dfs_agentiss_women "agent issue: agent dismissive of women (MM40_14)"
rename MM40_15 dfs_agentiss_fraud
la var dfs_agentiss_fraud "agent issue: agent committed fraud (MM40_15)"
rename MM40_16 dfs_agentiss_insecure
la var dfs_agentiss_insecure "agent issue: place not secure, suspicious people (MM40_16)"
rename MM40_17 dfs_agentiss_shareinfo
la var dfs_agentiss_shareinfo "agent issue: agent shared info with other people (MM40_17)"
rename MM40_18 dfs_agentiss_scam
la var dfs_agentiss_scam "agent issue: agent assisted others in defrauding or scamming (MM40_18)"
rename MM40_19 dfs_agentiss_id
la var dfs_agentiss_id "agent issue: agent refused transaction bc did not have id (MM40_19)"
rename MM40_20 dfs_agentiss_other
la var dfs_agentiss_other "agent issue: other(MM40_20)"

rename MM41 dfs_prob_who // see FII codebook for labels
la var dfs_prob_who "when an MM transaction goes wrong, who do you go to to help you resolve it? (see codebook for labels) (MM41)"

** Level of satisfaction before, after bank account/DFS: Section eliminated in W3
...
gen dfs_aware_spont=.
replace dfs_aware_spont=1 if MM2_1==1 | MM2_2==1 | MM2_3==1 | MM2_4==1 | MM2_5==1 | MM2_6==1
replace dfs_aware_spont=0 if MM2_1!=1 & MM2_2!=1 & MM2_3!=1 & MM2_4!=1 & MM2_5!=1 & MM2_6!=1
replace dfs_aware_spont=. if dfs_aware_gen==0
la var dfs_aware_spont "person could spontaneously recall name of any DFS provider (MM2_1-6)"

**PROMPTED RECALL of DFS providers
gen dfs_aware_prompt=.
replace dfs_aware_prompt=1 if MM3_1==1 | MM3_2==1 | MM3_3==1 | MM3_4==1 | MM3_5==1
replace dfs_aware_prompt=0 if MM3_1==2 & MM3_2==2 & MM3_3==2 & MM3_4==2 & MM3_5==2 
...
gen dfs_adopt=.
replace dfs_adopt=1 if MM4_1==1 | MM4_2==1 | MM4_3==1 | MM4_4==1 | MM4_5==1 | MM4_6==1
replace dfs_adopt=0 if MM4_1!=1 & MM4_2!=1 & MM4_3!=1 & MM4_4!=1 & MM4_5!=1 & MM4_6!=1
replace dfs_adopt=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
...
replace dfs_lastuse_yest=1 if MM5_1==1 | MM5_2==1 | MM5_3==1 | MM5_4==1 | MM5_5==1 | MM5_6==1
replace dfs_lastuse_yest=0 if MM5_1!=1 & MM5_2!=1 & MM5_3!=1 & MM5_4!=1 & MM5_5!=1 & MM5_6!=1
replace dfs_lastuse_yest=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_lastuse_yest "person used DFS yesterday (MM5_1-6)"

gen dfs_lastuse_week=.
replace dfs_lastuse_week=1 if MM5_1==2 | MM5_2==2 | MM5_3==2 | MM5_4==2 | MM5_5==2 | MM5_6==2
replace dfs_lastuse_week=0 if (MM5_1!=2 & MM5_2!=2 & MM5_3!=2 & MM5_4!=2 & MM5_5!=2 & MM5_6!=2) | dfs_lastuse_yest==1
replace dfs_lastuse_week=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_lastuse_week "person used DFS in the past 7 days (MM5_1-6)"

gen dfs_lastuse_month=.
replace dfs_lastuse_month=1 if MM5_1==3 | MM5_2==3 | MM5_3==3 | MM5_4==3 | MM5_5==3 | MM5_6==3
replace dfs_lastuse_month=0 if (MM5_1!=3 & MM5_2!=3 & MM5_3!=3 & MM5_4!=3 & MM5_5!=3 & MM5_6!=3) | dfs_lastuse_yest==1 | dfs_lastuse_week==1
replace dfs_lastuse_month=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_lastuse_month "person used DFS in the past 30 days (MM5_1-6)"

gen dfs_lastuse_90days=.
replace dfs_lastuse_90days=1 if MM5_1==4 | MM5_2==4 | MM5_3==4 | MM5_4==4 | MM5_5==4 | MM5_6==4
replace dfs_lastuse_90days=0 if (MM5_1!=4 & MM5_2!=4 & MM5_3!=4 & MM5_4!=4 & MM5_5!=4 & MM5_6!=4) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1
replace dfs_lastuse_90days=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_lastuse_90days "person used DFS in the past 90 days (MM5_1-6)"

gen dfs_lastuse_more90=.
replace dfs_lastuse_more90=1 if MM5_1==5 | MM5_2==5 | MM5_3==5 | MM5_4==5 | MM5_5==5 | MM5_6==5
replace dfs_lastuse_more90=0 if (MM5_1!=5 & MM5_2!=5 & MM5_3!=5 & MM5_4!=5 & MM5_5!=5 & MM5_6!=5) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1 | dfs_lastuse_90days==1
replace dfs_lastuse_more90=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM5_1-6)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if MM6_1==1 | MM6_2==1 | MM6_3==1 | MM6_4==1 | MM6_5==1 | MM6_6==1
replace dfs_regacct=0 if MM6_1!=1 & MM6_2!=1 & MM6_3!=1 & MM6_4!=1 & MM6_5!=1 & MM6_6!=1
replace dfs_regacct=. if MM6_1==. & MM6_2==. & MM6_3==. & MM6_4==. & MM6_5==. & MM6_6==.
la var dfs_regacct "person has a registered account with any DFS provider (MM8_1-6)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM11_1==1 | MM11_2==1 | MM11_3==1 | MM11_4==1 | MM11_5==1
replace dfs_access_otc=0 if MM11_1!=1 & MM11_2!=1 & MM11_3!=1 & MM11_4!=1 & MM11_5!=1
replace dfs_access_otc=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM11_1-5)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM11_1==2 | MM11_2==2 | MM11_3==2 | MM11_4==2 | MM11_5==2
replace dfs_access_fam=0 if MM11_1!=2 & MM11_2!=2 & MM11_3!=2 & MM11_4!=2 & MM11_5!=2
replace dfs_access_fam=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM11_1-5)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM11_1==3 | MM11_2==3 | MM11_3==3 | MM11_4==3 | MM11_5==3
replace dfs_access_nonhh=0 if MM11_1!=3 & MM11_2!=3 & MM11_3!=3 & MM11_4!=3 & MM11_5!=3
replace dfs_access_nonhh=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
...
gen dfs_access_work=.
replace dfs_access_work=1 if MM11_1==4 | MM11_2==4 | MM11_3==4 | MM11_4==4 | MM11_5==4
replace dfs_access_work=0 if MM11_1!=4 & MM11_2!=4 & MM11_3!=4 & MM11_4!=4 & MM11_5!=4
replace dfs_access_work=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM11_1-5)"

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM11_1==5 | MM11_2==5 | MM11_3==5 | MM11_4==5 | MM11_5==5
replace dfs_access_ownacct=0 if MM11_1!=5 & MM11_2!=5 & MM11_3!=5 & MM11_4!=5 & MM11_5!=5
replace dfs_access_ownacct=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM11_1-5)"

//ATM 
gen dfs_access_atm=.
replace dfs_access_atm=1 if MM11_1==6 | MM11_2==6 | MM11_3==6 | MM11_4==6 | MM11_5==6
replace dfs_access_atm=0 if MM11_1!=6 & MM11_2!=6 & MM11_3!=6 & MM11_4!=6 & MM11_5!=6
replace dfs_access_atm=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_atm "person usually accesses DFS via ATM (MM11_1-6)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM11_1==7 | MM11_2==7 | MM11_3==7 | MM11_4==7 | MM11_5==7
replace dfs_access_other=0 if MM11_1!=7 & MM11_2!=7 & MM11_3!=7 & MM11_4!=7 & MM11_5!=7
replace dfs_access_other=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==.
la var dfs_access_other "person usually accesses DFS in an other way (MM11_1-6)"


*REMITTANCES - changed significantly from W2
count if DL4_5==1 //Please tell me which of these ways you got money in the past 12 months? From family, friends, spouse for regular support or emergencies.
count if DL5==5 //Which of these ways brought you the most money in the past 12 mos.?

gen rec_remit=.
replace rec_remit=1 if DL4_5==1
replace rec_remit=0 if DL4_5==2
replace rec_remit=. if DL4_5==.

gen remit_main=.
replace remit_main=1 if DL5==5
replace remit_main=0 if DL5!=5
replace remit_main=. if DL5==.
...
//Label variable values 0=no; 1=yes
#d 
local yesnogen  married rural employed official_id rec_support dfs_aware_spont dfs_aware_prompt 
	dfs_adopt dfs_lastuse_yest dfs_lastuse_week dfs_lastuse_month dfs_lastuse_90days dfs_aware_name
	dfs_lastuse_more90 dfs_regacct dfs_access_otc dfs_access_fam dfs_access_nonhh dfs_access_work dfs_access_ownacct 
...
save "$output\Tanzania_W3_Clean.dta", replace
