...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Nigeria Financial Inclusion Insights Wave 3 data set.
...
*After downloading the "FSP_Final_Nigeria_W3 (public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Nigeria_W3 (public).xlsx", firstrow clear
save "filepath for location where you want to save dta file/Nigeria_Wave3_Stata.dta", replace
clear
...
*Nigeria*
*******
use "$input\Nigeria_Wave3_Stata.dta"
...
la var urban_rural "settlement size (Location)"
...
//31 missing ages coded as 999; replace 999 with missing
...
//Number of persons in the household (DG8) - 2 obs coded as 999, changed to missing
gen n_household=.
replace DG8a=. if DG8a==999
replace DG8b=. if DG8b==999
replace DG8c=. if DG8c==999
...
label define dfs_prob_who1 1 "Resolve it yourself" 2 "MM agent" 3 "MM provider/customer service" 4 "Family member" /*
		*/ 5 "Friend or neighbor" 6 "Other" 7 "MM transactions never go wrong" 
	label values dfs_prob_who dfs_prob_who1


** Level of satisfaction - section eliminated in W3
...
gen rec_support=.
replace rec_support=1 if DL5 <=5 | DL5==23
replace rec_support=0 if DL5>=6 & DL5!=23
la var rec_support "person is receives financial support from family, government, or non-profit org (DL5)"
...
replace dfs_aware_spont=0 if MM2_1!=1 & MM2_2!=1 & MM2_3!=1 & MM2_4!=1 & MM2_5!=1 & MM2_6!=1 & MM2_7!=1 & MM2_8!=1 & MM2_9!=1 & MM2_10!=1 & MM2_11!=1 & MM2_12!=1 & MM2_13!=1 & MM2_14!=1
...
la var dfs_aware_prompt "person could recall name of any DFS provider when prompted with name(MM3_1-13)"
...
gen dfs_adopt=.
replace dfs_adopt=1 if MM4_1==1 | MM4_2==1 | MM4_3==1 | MM4_4==1 | MM4_5==1 | MM4_6==1 | MM4_7==1 | MM4_8==1 | MM4_9==1 | MM4_10==1 | MM4_11==1 | MM4_12==1 | MM4_13==1 | MM4_14==1  
replace dfs_adopt=0 if dfs_aware_name==1 & dfs_adopt!=1
replace dfs_adopt=. if dfs_aware_name==0
la var dfs_adopt "person has ever used DFS for any financial activity (MM4_2-14)"
...
replace dfs_lastuse_yest=1 if MM5_1==1 | MM5_2==1 | MM5_3==1 | MM5_4==1 | MM5_5==1 | MM5_6==1 | MM5_7==1 | MM5_8==1 | MM5_9==1 | MM5_10==1 | MM5_11==1 | MM5_12==1 | MM5_13==1 | MM5_14==1  
replace dfs_lastuse_yest=0 if MM5_1!=1 & MM5_2!=1 & MM5_3!=1 & MM5_4!=1 & MM5_5!=1 & MM5_6!=1 & MM5_7!=1 & MM5_8!=1 & MM5_9!=1 & MM5_10!=1 & MM5_11!=1 & MM5_12!=1 & MM5_13!=1 & MM5_14!=1
replace dfs_lastuse_yest=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_lastuse_yest "person used DFS yesterday (MM5_1-14)"

gen dfs_lastuse_week=.
replace dfs_lastuse_week=1 if MM5_1==2 | MM5_2==2 | MM5_3==2 | MM5_4==2 | MM5_5==2 | MM5_6==2 | MM5_7==2 | MM5_8==2 | MM5_9==2 | MM5_10==2 | MM5_11==2 | MM5_12==2 | MM5_13==2 | MM5_14==2
replace dfs_lastuse_week=0 if (MM5_1!=2 & MM5_2!=2 & MM5_3!=2 & MM5_4!=2 & MM5_5!=2 & MM5_6!=2 & MM5_7!=2 & MM5_8!=2 & MM5_9!=2 & MM5_10!=2 & MM5_11!=2 & MM5_12!=2 & MM5_13!=2 & MM5_14!=2) | dfs_lastuse_yest==1
replace dfs_lastuse_week=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_lastuse_week "person used DFS in the past 7 days (MM5_1-14)"

gen dfs_lastuse_month=.
replace dfs_lastuse_month=1 if MM5_1==3 | MM5_2==3 | MM5_3==3 | MM5_4==3 | MM5_5==3 | MM5_6==3 | MM5_7==3 | MM5_8==3 | MM5_9==3 | MM5_10==3 | MM5_11==3 | MM5_12==3 | MM5_13==3 | MM5_14==3
replace dfs_lastuse_month=0 if (MM5_1!=3 & MM5_2!=3 & MM5_3!=3 & MM5_4!=3 & MM5_5!=3 & MM5_6!=3 & MM5_7!=3 & MM5_8!=3 & MM5_9!=3 & MM5_10!=3 & MM5_11!=3 & MM5_12!=3 & MM5_13!=3 & MM5_14!=3) | dfs_lastuse_yest==1 | dfs_lastuse_week==1
replace dfs_lastuse_month=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_lastuse_month "person used DFS in the past 30 days (MM5_1-14)"

gen dfs_lastuse_90days=.
replace dfs_lastuse_90days=1 if MM5_1==4 | MM5_2==4 | MM5_3==4 | MM5_4==4 | MM5_5==4 | MM5_6==4 | MM5_7==4 | MM5_8==4 | MM5_9==4 | MM5_10==4 | MM5_11==4 | MM5_12==4 | MM5_13==4 | MM5_14==4
replace dfs_lastuse_90days=0 if (MM5_1!=4 & MM5_2!=4 & MM5_3!=4 & MM5_4!=4 & MM5_5!=4 & MM5_6!=4 & MM5_7!=4 & MM5_8!=4 & MM5_9!=4 & MM5_10!=4 & MM5_11!=4 & MM5_12!=4 & MM5_13!=4 & MM5_14!=4) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1
replace dfs_lastuse_90days=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_lastuse_90days "person used DFS in the past 90 days (MM5_1-14)"

gen dfs_lastuse_more90=.
replace dfs_lastuse_more90=1 if MM5_1==5 | MM5_2==5 | MM5_3==5 | MM5_4==5 | MM5_5==5 | MM5_6==5 | MM5_7==5 | MM5_8==5 | MM5_9==5 | MM5_10==5 | MM5_11==5 | MM5_12==5 | MM5_13==5 | MM5_14==5
replace dfs_lastuse_more90=0 if (MM5_1!=5 & MM5_2!=5 & MM5_3!=5 & MM5_4!=5 & MM5_5!=5 & MM5_6!=5 & MM5_7!=5 & MM5_8!=5 & MM5_9!=5 & MM5_10!=5 & MM5_11!=5 & MM5_12!=5 & MM5_13!=5 & MM5_14!=5) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1 | dfs_lastuse_90days==1
replace dfs_lastuse_more90=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM5_1-14)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if MM6_1==1 | MM6_2==1 | MM6_3==1 | MM6_4==1 | MM6_5==1 | MM6_6==1 | MM6_7==1 | MM6_8==1 | MM6_9==1 | MM6_10==1 | MM6_11==1 | MM6_12==1 | MM6_13==1 | MM6_14==1
replace dfs_regacct=0 if MM6_1!=1 & MM6_2!=1 & MM6_3!=1 & MM6_4!=1 & MM6_5!=1 & MM6_6!=1 & MM6_7!=1 & MM6_8!=1 & MM6_9!=1 & MM6_10!=1 & MM6_11!=1 & MM6_12!=1 & MM6_13!=1 & MM6_14!=1
replace dfs_regacct=. if MM6_1==. & MM6_2==. & MM6_3==. & MM6_4==. & MM6_5==. & MM6_6==. & MM6_7==. & MM6_8==. & MM6_9==. & MM6_10==. & MM6_11==. & MM6_12==. & MM6_13==. & MM6_14==.
la var dfs_regacct "person has a registered account with any DFS provider (MM6_1-14)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM11_1==1 | MM11_2==1 | MM11_3==1 | MM11_4==1 | MM11_5==1 | MM11_6==1 | MM11_7==1 | MM11_8==1 | MM11_9==1 | MM11_10==1 | MM11_11==1 | MM11_12==1 | MM11_13==1 | MM11_14==1
replace dfs_access_otc=0 if MM11_1!=1 & MM11_2!=1 & MM11_3!=1 & MM11_4!=1 & MM11_5!=1 & MM11_6!=1 & MM11_7!=1 & MM11_8!=1 & MM11_9!=1 & MM11_10!=1 & MM11_11!=1 & MM11_12!=1 & MM11_13!=1 & MM11_14!=1
replace dfs_access_otc=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM11_1-14)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM11_1==2 | MM11_2==2 | MM11_3==2 | MM11_4==2 | MM11_5==2 | MM11_6==2 | MM11_7==2 | MM11_8==2 | MM11_9==2 | MM11_10==2 | MM11_11==2 | MM11_12==2 | MM11_13==2 | MM11_14==2
replace dfs_access_fam=0 if MM11_1!=2 & MM11_2!=2 & MM11_3!=2 & MM11_4!=2 & MM11_5!=2 & MM11_6!=2 & MM11_7!=2 & MM11_8!=2 & MM11_9!=2 & MM11_10!=2 & MM11_11!=2 & MM11_12!=2 & MM11_13!=2 & MM11_14!=2
replace dfs_access_fam=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM11_1-14)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM11_1==3 | MM11_2==3 | MM11_3==3 | MM11_4==3 | MM11_5==3 | MM11_6==3 | MM11_7==3 | MM11_8==3 | MM11_9==3 | MM11_10==3 | MM11_11==3 | MM11_12==3 | MM11_13==3 | MM11_14==3
replace dfs_access_nonhh=0 if MM11_1!=3 & MM11_2!=3 & MM11_3!=3 & MM11_4!=3 & MM11_5!=3 & MM11_6!=3 & MM11_7!=3 & MM11_8!=3 & MM11_9!=3 & MM11_10!=3 & MM11_11!=3 & MM11_12!=3 & MM11_13!=3 & MM11_14!=3
replace dfs_access_nonhh=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM11_1-14)"

//Account of a workmate or a business partner
gen dfs_access_work=.
replace dfs_access_work=1 if MM11_1==4 | MM11_2==4 | MM11_3==4 | MM11_4==4 | MM11_5==4 | MM11_6==4 | MM11_7==4 | MM11_8==4 | MM11_9==4 | MM11_10==4 | MM11_11==4 | MM11_12==4 | MM11_13==4 | MM11_14==4
replace dfs_access_work=0 if MM11_1!=4 & MM11_2!=4 & MM11_3!=4 & MM11_4!=4 & MM11_5!=4 & MM11_6!=4 & MM11_7!=4 & MM11_8!=4 & MM11_9!=4 & MM11_10!=4 & MM11_11!=4 & MM11_12!=4 & MM11_13!=4 & MM11_14!=4
replace dfs_access_work=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM11_1-14)"

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM11_1==5 | MM11_2==5 | MM11_3==5 | MM11_4==5 | MM11_5==5 | MM11_6==5 | MM11_7==5 | MM11_8==5 | MM11_9==5 | MM11_10==5 | MM11_11==5 | MM11_12==5 | MM11_13==5 | MM11_14==5
replace dfs_access_ownacct=0 if MM11_1!=5 & MM11_2!=5 & MM11_3!=5 & MM11_4!=5 & MM11_5!=5 & MM11_6!=5 & MM11_7!=5 & MM11_8!=5 & MM11_9!=5 & MM11_10!=5 & MM11_11!=5 & MM11_12!=5 & MM11_13!=5 & MM11_14!=5
replace dfs_access_ownacct=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM11_1-14)"

//ATM
gen dfs_access_atm=.
replace dfs_access_atm=1 if MM11_1==6 | MM11_2==6 | MM11_3==6 | MM11_4==6 | MM11_5==6 | MM11_6==6 | MM11_7==6 | MM11_8==6 | MM11_9==6 | MM11_10==6 | MM11_11==6 | MM11_12==6 | MM11_13==6 | MM11_14==6
replace dfs_access_atm=0 if MM11_1!=6 & MM11_2!=6 & MM11_3!=6 & MM11_4!=6 & MM11_5!=6 & MM11_6!=6 & MM11_7!=6 & MM11_8!=6 & MM11_9!=6 & MM11_10!=6 & MM11_11!=6 & MM11_12!=6 & MM11_13!=6 & MM11_14!=6
replace dfs_access_atm=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_atm "person usually accesses DFS via ATM (MM11_1-14)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM11_1==7 | MM11_2==7 | MM11_3==7 | MM11_4==7 | MM11_5==7 | MM11_6==7 | MM11_7==7 | MM11_8==7 | MM11_9==7 | MM11_10==7 | MM11_11==7 | MM11_12==7 | MM11_13==7 | MM11_14==7
replace dfs_access_other=0 if MM11_1!=7 & MM11_2!=7 & MM11_3!=7 & MM11_4!=7 & MM11_5!=7 & MM11_6!=7 & MM11_7!=7 & MM11_8!=7 & MM11_9!=7 & MM11_10!=7 & MM11_11!=7 & MM11_12!=7 & MM11_13!=7 & MM11_14!=7
replace dfs_access_other=. if MM11_1==. & MM11_2==. & MM11_3==. & MM11_4==. & MM11_5==. & MM11_6==. & MM11_7==. & MM11_8==. & MM11_9==. & MM11_10==. & MM11_11==. & MM11_12==. & MM11_13==. & MM11_14==.
la var dfs_access_other "person usually accesses DFS in an other way (MM11_1-14)"
...
count if DL5==5 //Which brought you the most money in the past 12 mos.?

gen rec_remit=.
replace rec_remit=1 if DL4_5==1 
replace rec_remit=0 if DL4_5==2 
la var rec_remit "person receives remittances (DL4_5)"
tab rec_remit //% of people receiving remittances in the past 12 mos.
...
local yesnogen rural married official_id employed dfs_aware_spont dfs_aware_prompt dfs_aware_name
	...
	dfs_regacct dfs_access_otc dfs_access_fam dfs_access_nonhh dfs_access_work dfs_access_ownacct dfs_access_atm dfs_access_other
	rec_remit remit_main ppi_cutoff literate numerate
;
	#d cr
...
save "$output\Nigeria_W3_Clean.dta", replace
