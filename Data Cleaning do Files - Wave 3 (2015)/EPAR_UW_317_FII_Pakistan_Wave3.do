...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Pakistan Financial Inclusion Insights Wave 3 data set.
...
*After downloading the "FSP_Final_Pakistan_W3 (public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
*Pakistan*
*******
use "$input\Pakistan_Wave3_Stata.dta"
...
rename aa6 urban_rural //1=urban, 2=rural 
la var urban_rural "settlement size (aa6)"
...
la var primary_job "individual's primary job (dl2)"
	label define primary_job1 1 "Farmer owner/farmer" 2 "Farm worker" 3 "Public or health service worker (non-prof)" 4 "Professional (i.e. doctor, teacher, nurse)" /*
		...
		*/ 30 "Manual Labor" 33 "Other (specify in row)" 34 "Refused/prefer not to say"
	label values primary_job primary_job1

**Fix employment_status
tab employment_status 
replace employment_status=5 if employment_status==13 & primary_job==1	
...
la var highest_ed "highest level of education (dg4)"
	label define highest_edl 1 "No formal education can't read" 2 "No formal education can read" 3 "Primary education not complete" 4 "Primary education complete" /*
		*/ 5 "Some secondary" 6 "Secondary education complete" 7 "Some secondary vocational training/some certificate" /*
		*/ 8 "Secondary vocational training or certificate complete" 9 "Some diploma" 10 "Diploma complete" 11 "Some college/university" /* 
		*/ 12 "Complete university degree" 13 "Post-graduate university degree" 14 "Koranic school" 15 "Other (specify)" 16 "DK/Refused"
...
rename mt2 phone_own //1=yes, 2=no
la var phone_own "person owns a mobile phone (mt2)" 
rename mt1 house_phone
la var house_phone "how many people in your household own a phone (mt1)"
rename mt7 phone_access //1=yes, 2=no
...
rename ff9 bank_lastuse
la var bank_lastuse "apart from today, last time used bank acct (see codebook for labels) (ff9)" 
...
la var dfs_airtime "Buy mobile phone recharges/Pay mobile bill (mm15_3)"
...
la var dfs_payfam_reg "person has used DFS to send money to fam/friends for reg support or emergency (mm15_10)"
rename mm15_11 dfs_recfam_reg
la var dfs_recfam_reg "person has used DFS to receive money to fam/friends for reg support or emergency (mm15_11)"
...
rename mm15_15 dfs_payins
la var dfs_payins "person has used DFS to make insurance pmts (mm15_15)"
...
la var dfs_savepurchase "person has used DFS to save for future purchases, pension (mm15_17)"
...
la var dfs_transferother "person has used DFS to transfer btwen mm act and act at other fin institution (mm15_23)"
rename mm15_24 dfs_savings
la var dfs_savings "pay or receive money from savings or lending group (mm15_24)"
rename mm15_25 dfs_rent
la var dfs_rent "person has used DFS to pay rent (mm15_25)"


**Use of DFS for business payments/purchases
...
//there is no mm22_4, questionnaire skips 4 for unknown reason
...
la var dfs_bus_payexp "person has used DFS to pay other business related expenses (i.e.rent) (mm22_7)"
...
//**W2 "Transport to agent" section removed in W3, new questions in IFI
...
la var dfs_agentiss_id "agent issue: agent refused trans bbc did not have id (mm38_19)"
...
*/dfs_recwage dfs_paylarge dfs_payins dfs_takeloan dfs_savepurchase /*
...
**MARRIED (if monogomously or polygamously married - does not include widowed, divorced, etc.)
gen married=.
...
replace rec_support=0 if dl5 >=6 & dl5!=23 &dl5!=.
...
**Only asked if yes to dfs_aware_gen, person is aware of mobile money
gen dfs_aware_spont=.
replace dfs_aware_spont=1 if mm2_1==1 | mm2_2==1 | mm2_3==1 | mm2_4==1 | mm2_5==1 | mm2_6==1 | mm2_7==1 | mm2_8==1 | mm2_9==1 | mm2_10==1 | mm2_11==1 | mm2_12==1
replace dfs_aware_spont=0 if dfs_aware_gen==1 & mm2_1!=1 & mm2_2!=1 & mm2_3!=1 & mm2_4!=1 & mm2_5!=1 & mm2_6!=1 & mm2_7!=1 & mm2_8!=1 & mm2_9!=1 
la var dfs_aware_spont "person could spontaneously recall name of any DFS provider (mm2_1-12)"
...
replace dfs_aware_prompt=0 if dfs_aware_prompt!=1
...
**SECTION ELIMINATED IN W3: SOURCE OF INFORMATION FROM WHICH THEY LEARNED ABOUT DFS
...
la var dfs_adopt "person has ever used DFS for any financial activity (mm4_2-8)"
...
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (mm5_1-8)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if mm6_1==1 | mm6_2==1 | mm6_3==1 | mm6_4==1 | mm6_5==1 | mm6_6==1 | mm6_7==1 | mm6_8==1
...
replace dfs_access_ownacct=1 if mm11_1==1 | mm11_2==1 | mm11_3==1 | mm11_4==1 | mm11_5==1 | mm11_6==1 | mm11_7==1 | mm11_8==1
replace dfs_access_ownacct=0 if mm11_1!=1 & mm11_2!=1 & mm11_3!=1 & mm11_4!=1 & mm11_5!=1 & mm11_6!=1 & mm11_7!=1 & mm11_8!=1
...
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (mm11_1-8)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if mm11_1==5 | mm11_2==5 | mm11_3==5 | mm11_4==5 | mm11_5==5 | mm11_6==5 | mm11_7==5 | mm11_8==5
replace dfs_access_otc=0 if mm11_1!=5 & mm11_2!=5 & mm11_3!=5 & mm11_4!=5 & mm11_5!=5 & mm11_6!=5 & mm11_7!=5 & mm11_8!=5
...
count if dl4_5==1 //Do you supplement your income by any of the following? 5=Money from family/friends/spouse for regular support or emergencies
count if dl5==5 //Which of the following options brought you the most money in the past 12 months? 

gen rec_remit=.
replace rec_remit=0 if dl4_5==2 
replace rec_remit=1 if dl4_5==1 
la var rec_remit "person receives remittances (DL4_5)"
tab rec_remit //% of the population receiving remittances
...
**Questions eliminated in W3: COMFORT/SKILL WITH MOBILE TECHNOLOGY td12 eliminated)
...
local yesnogen rural married official_id employed rec_support dfs_aware_spont dfs_aware_prompt dfs_aware_name
	...
	dfs_regacct dfs_access_ownacct dfs_access_fam dfs_access_nonhh dfs_access_work dfs_access_otc dfs_access_atm
	dfs_access_other rec_remit remit_main ppi_cutoff literate numerate 
;
	#d cr
...
*********************************
save "$output\Pakistan_W3_Clean.dta", replace
