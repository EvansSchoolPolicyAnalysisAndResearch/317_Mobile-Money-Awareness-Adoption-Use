...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Indonesia Financial Inclusion Insights Wave 2 data set.
...
*-----------
*This Master do.file constructs selected sociodemogaphic and mobile money uptake outcome variables from the Indonesia Financial Inclusion Insights Wave 2 data set.
*After downloading the "FSP_Final_Indonesia_W2 (public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Indonesia_W2 (public).xlsx", firstrow clear
save "filepath for location where you want to save dta file/Indonesia_Wave2_Stata.dta", replace
clear
...
*Indonesia*
************
use "$input\Indonesia_Wave2_Stata.dta"

*********************************************
** RENAME VARIABLES TO BE USED IN ANALYSIS **
*********************************************
//Generate dummy variable for Indonesia (for when appending to other files) 
gen Indonesia=1 

**IMPORTANT: WAVE 2 IN INDONESIA IS CONCURRENT WITH WAVE 3 IN OTHER COUNTRIES (only 2 Waves in Indonesia)
...
//17 missing ages listed as 999; replace with missing
...
la var employment_status "employment status of individual (DL1)"
	label define employment_statusl 1 "Working full-time for a regular salary" 2 "Working part-time for a regular salary" 3 "Working occasionally, irregular pay" /*
		*/ 4 "Per season" 5 "Self-employed, working for yourself" 6 "Not working but looking for a job" 7 "Housewife, doing household chores" 8 "Full-time student" /*
		*/ 9 "Not working because of retirement" 10 "Not working because of sickness, disability, etc." 11 "Other(specify)" 12 "DK/Refused"
...
destring reason_nobankacct, replace
	label define reason_nobankacctl 1 "I do not know what it is" 2 "I do not know how to open one" 3 "I do not have a state-issued/national ID or other req. docs" /*
		...
		*/ 27 "I will not be able to go to a bank on my own" 28 "It's not approved by my religion" /*
		*/  29 "Other(specify)" 30 "DK/Refused"
...
destring dfs_reasonnouse, replace
	label define dfs_reasonnousel 1 "I do not know what it is" 2 "I do not know how to open one" 3 "I do not have a state ID or other req. docs" /*
		...
		*/ 14 "I do not trust that my money is safe on MM" 15 "My husband/family/in-laws do not approve of me having a MM account" /*
...
destring dfs_reasonnoreg, replace
	label define dfs_reasonnoregl 1 "I do not have a state ID or other req. docs" 2 "There is no point-of-service/agent close to where I live" /*
		...
		*/ 12 "I do not trust my money is safe on a MM account" 13 "I prefer to keep money in cash and useMM only to send/receive money" /*
		*/ 14 "I have heard of fraud on MM" 15 "Agent can help me use the service/I do not know how to use it on my own" /*
...
//Only 25 people have ever used DFS, so these variables may not be useful

**Uses of DFS - Only asked of the 25 ppl who have ever used DFS
...
**Level of satisfaction with financial options - eliminated in W3
...
replace official_id=0 if DG5_19==1
la var official_id "has any type of official identification (DG5_1 to DG5_18)"
...
gen dfs_aware_spont=.
replace dfs_aware_spont=1 if MM2_1==1 | MM2_2==1 | MM2_3==1 | MM2_4==1 | MM2_5==1 | MM2_6==1 | MM2_7==1 | MM2_8==1 | MM2_9==1
replace dfs_aware_spont=0 if MM2_1!=1 & MM2_2!=1 & MM2_3!=1 & MM2_4!=1 & MM2_5!=1 & MM2_6!=1 & MM2_7!=1 & MM2_8!=1 & MM2_9!=1
replace dfs_aware_spont=. if dfs_aware_gen==0
la var dfs_aware_spont "person could spontaneously recall name of any DFS provider (MM2_1-9)"

**PROMPTED RECALL of DFS providers
//Dropped out 'Other' bc cannot prompt 'Other'
...
replace dfs_lastuse_yest=1 if MM8_1==1 | MM8_2==1 | MM8_3==1 | MM8_4==1 | MM8_5==1 | MM8_6==1 | MM8_7==1 | MM8_8==1 | MM8_9==1 
replace dfs_lastuse_yest=0 if MM8_1!=1 & MM8_2!=1 & MM8_3!=1 & MM8_4!=1 & MM8_5!=1 & MM8_6!=1 & MM8_7!=1 & MM8_8!=1 & MM8_9!=1 
replace dfs_lastuse_yest=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_8==. & MM8_9==.
la var dfs_lastuse_yest "person used DFS yesterday (MM8_1-9)"

gen dfs_lastuse_week=.
replace dfs_lastuse_week=1 if MM8_1==2 | MM8_2==2 | MM8_3==2 | MM8_4==2 | MM8_5==2 | MM8_6==2 | MM8_7==2 | MM8_8==2 | MM8_9==2
replace dfs_lastuse_week=0 if (MM8_1!=2 & MM8_2!=2 & MM8_3!=2 & MM8_4!=2 & MM8_5!=2 & MM8_6!=2 & MM8_7!=2 & MM8_8!=2 & MM8_9!=2) | dfs_lastuse_yest==1
replace dfs_lastuse_week=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_8==. & MM8_9==.
la var dfs_lastuse_week "person used DFS in the past 7 days (MM8_1-9)"

gen dfs_lastuse_month=.
replace dfs_lastuse_month=1 if MM8_1==3 | MM8_2==3 | MM8_3==3 | MM8_4==3 | MM8_5==3 | MM8_6==3 | MM8_7==3 | MM8_8==3 | MM8_9==3
replace dfs_lastuse_month=0 if (MM8_1!=3 & MM8_2!=3 & MM8_3!=3 & MM8_4!=3 & MM8_5!=3 & MM8_6!=3 & MM8_7!=3 & MM8_8!=3 & MM8_9!=3) | dfs_lastuse_yest==1 | dfs_lastuse_week==1
replace dfs_lastuse_month=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_7==. & MM8_8==. & MM8_9==.
la var dfs_lastuse_month "person used DFS in the past 30 days (MM8_1-9)"

gen dfs_lastuse_90days=.
replace dfs_lastuse_90days=1 if MM8_1==4 | MM8_2==4 | MM8_3==4 | MM8_4==4 | MM8_5==4 | MM8_6==4 | MM8_7==4 | MM8_8==4 | MM8_9==4 
replace dfs_lastuse_90days=0 if (MM8_1!=4 & MM8_2!=4 & MM8_3!=4 & MM8_4!=4 & MM8_5!=4 & MM8_6!=4 & MM8_7!=4 & MM8_8!=4 & MM8_9!=4) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1
replace dfs_lastuse_90days=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_7==. & MM8_8==. & MM8_9==.
la var dfs_lastuse_90days "person used DFS in the past 90 days (MM8_1-9)"

gen dfs_lastuse_more90=.
replace dfs_lastuse_more90=1 if MM8_1==5 | MM8_2==5 | MM8_3==5 | MM8_4==5 | MM8_5==5 | MM8_6==5 | MM8_7==5 | MM8_8==5 | MM8_9==5 
replace dfs_lastuse_more90=0 if (MM8_1!=5 & MM8_2!=5 & MM8_3!=5 & MM8_4!=5 & MM8_5!=5 & MM8_6!=5 & MM8_7!=5 & MM8_8!=5 & MM8_9!=5) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1 | dfs_lastuse_90days==1
replace dfs_lastuse_more90=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_7==. & MM8_8==. & MM8_9==.
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM8_1-9)"
...
**REGISTERED ACCOUNT
//Question: Do you have a registered account with this mobile money service?
//One question for each DFS provider, so we are combining them 
recode MM6_* (2=0)
egen dfs_regacct = rowmax (MM6_*)
la var dfs_regacct "person has a registered account with any DFS provider (MM6_1-9)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM11_1_1==1 | MM11_2_1==1 | MM11_3_1==1 | MM11_4_1==1 | MM11_5_1==1 | MM11_6_1==1 | MM11_7_1==1 | MM11_8_1==1 | MM11_9_1==1
replace dfs_access_otc=0 if MM11_1_1!=1 & MM11_2_1!=1 & MM11_3_1!=1 & MM11_4_1!=1 & MM11_5_1!=1 & MM11_6_1!=1 & MM11_7_1!=1 & MM11_8_1!=1 & MM11_9_1!=1
replace dfs_access_otc=. if MM11_1_1==. & MM11_2_1==. & MM11_3_1==. & MM11_4_1==. & MM11_5_1==. & MM11_6_1==. & MM11_7_1==. & MM11_8_1==. & MM11_9_1==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM11_1_1 to 11_9_1)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM11_1_2==1 | MM11_2_2==1 | MM11_3_2==1 | MM11_4_2==1 | MM11_5_2==1 | MM11_6_2==1 | MM11_7_2==1 | MM11_8_2==1 | MM11_9_2==1
replace dfs_access_fam=0 if MM11_1_2!=1 & MM11_2_2!=1 & MM11_3_2!=1 & MM11_4_2!=1 & MM11_5_2!=1 & MM11_6_2!=1 & MM11_7_2!=1 & MM11_8_2!=1 & MM11_9_2!=1
replace dfs_access_fam=. if MM11_1_2==. & MM11_2_2==. & MM11_3_2==. & MM11_4_2==. & MM11_5_2==. & MM11_6_2==. & MM11_7_2==. & MM11_8_2==. & MM11_9_2==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM11_1_2 to 11_9_2)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM11_1_3==1 | MM11_2_3==1 | MM11_3_3==1 | MM11_4_3==1 | MM11_5_3==1 | MM11_6_3==1 | MM11_7_3==1 | MM11_8_3==1 | MM11_9_3==1
replace dfs_access_nonhh=0 if MM11_1_3!=1 & MM11_2_3!=1 & MM11_3_3!=1 & MM11_4_3!=1 & MM11_5_3!=1 & MM11_6_3!=1 & MM11_7_3!=1 & MM11_8_3!=1 & MM11_9_3!=1
replace dfs_access_nonhh=. if MM11_1_3==. & MM11_2_3==. & MM11_3_3==. & MM11_4_3==. & MM11_5_3==. & MM11_6_3==. & MM11_7_3==. & MM11_8_3==. & MM11_9_3==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM11_1_3 to 11_9_3)"

//Account of a workmate or a business partner 
gen dfs_access_work=.
replace dfs_access_work=1 if MM11_1_4==1 | MM11_2_4==1 | MM11_3_4==1 | MM11_4_4==1 | MM11_5_4==1 | MM11_6_4==1 | MM11_7_4==1 | MM11_8_4==1 | MM11_9_4==1
replace dfs_access_work=0 if MM11_1_4!=1 & MM11_2_4!=1 & MM11_3_4!=1 & MM11_4_4!=1 & MM11_5_4!=1 & MM11_6_4!=1 & MM11_7_4!=1 & MM11_8_4!=1 & MM11_9_4!=1
replace dfs_access_work=. if MM11_1_4==. & MM11_2_4==. & MM11_3_4==. & MM11_4_4==. & MM11_5_4==. & MM11_6_4==. & MM11_7_4==. & MM11_8_4==. & MM11_9_4==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM11_1_4 to 15_9_4)" 

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM11_1_5==1 | MM11_2_5==1 | MM11_3_5==1 | MM11_4_5==1 | MM11_5_5==1 | MM11_6_5==1 | MM11_7_5==1 | MM11_8_5==1 | MM11_9_5==1
replace dfs_access_ownacct=0 if MM11_1_5!=1 & MM11_2_5!=1 & MM11_3_5!=1 & MM11_4_5!=1 & MM11_5_5!=1 & MM11_6_5!=1 & MM11_7_5!=1 & MM11_8_5!=1 & MM11_9_5!=1
replace dfs_access_ownacct=. if MM11_1_5==. & MM11_2_5==. & MM11_3_5==. & MM11_4_5==. & MM11_5_5==. & MM11_6_5==. & MM11_7_5==. & MM11_8_5==. & MM11_9_5==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM11_1_5 to 11_9_5)"

//ATM
gen dfs_access_atm=.
replace dfs_access_atm=1 if MM11_1_6==1 | MM11_2_6==1 | MM11_3_6==1 | MM11_4_6==1 | MM11_5_6==1 | MM11_6_6==1 | MM11_7_6==1 | MM11_8_6==1 | MM11_9_6==1
replace dfs_access_atm=0 if MM11_1_6!=1 & MM11_2_6!=1 & MM11_3_6!=1 & MM11_4_6!=1 & MM11_5_6!=1 & MM11_6_6!=1 & MM11_7_6!=1 & MM11_8_6!=1 & MM11_9_6!=1
replace dfs_access_atm=. if MM11_1_6==. & MM11_2_6==. & MM11_3_6==. & MM11_4_6==. & MM11_5_6==. & MM11_6_6==. & MM11_7_6==. & MM11_8_6==. & MM11_9_6==.
la var dfs_access_atm "person usually accesses DFS in an other way (MM11_1_6 to 11_9_6)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM11_1_7==1 | MM11_2_7==1 | MM11_3_7==1 | MM11_4_7==1 | MM11_5_7==1 | MM11_6_7==1 | MM11_7_7==1 | MM11_8_7==1 | MM11_9_7==1
replace dfs_access_other=0 if MM11_1_7!=1 & MM11_2_7!=1 & MM11_3_7!=1 & MM11_4_7!=1 & MM11_5_7!=1 & MM11_6_7!=1 & MM11_7_7!=1 & MM11_8_7!=1 & MM11_9_7!=1
replace dfs_access_other=. if MM11_1_7==. & MM11_2_7==. & MM11_3_7==. & MM11_4_7==. & MM11_5_7==. & MM11_6_7==. & MM11_7_7==. & MM11_8_7==. & MM11_9_7==.
la var dfs_access_other "person usually accesses DFS in an other way (MM11_1_6 to 11_9_6)"


*REMITTANCES
count if DL4_5==1 //Which of the following ways did you get money in the past 12 mos.? Money from fam, friends for regular support or emergencies.
...
local yesnogen rural married official_id employed dfs_aware_spont dfs_aware_prompt dfs_aware_name
	...
	dfs_access_ownacct dfs_access_atm dfs_access_other rec_remit remit_main ppi_cutoff literate numerate
;
	#d cr
...
save "$output\Indonesia_W2_Clean.dta", replace
