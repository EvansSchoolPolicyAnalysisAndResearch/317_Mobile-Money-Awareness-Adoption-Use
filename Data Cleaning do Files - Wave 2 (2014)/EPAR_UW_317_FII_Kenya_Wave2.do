...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Kenya Financial Inclusion Insights Wave 2 data set.
...
*After downloading the "FSP_Final_Kenya_w2_12092014(public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Kenya_w2_12092014(public).xlsx", sheet("FSP_Final_Kenya_w2_12092014(pub"), firstrow
save "filepath for location where you want to save dta file/Kenya_Wave2_Stata.dta", replace
clear
...
*Kenya*
*******
use "$input\Kenya_Wave2_Stata.dta"
...
rename AA9 urban_rural //1=urban, 2=rural
la var urban_rural "settlement size (AA9)"
...
destring primary_job, replace 
	label define primary_jobl 1 "Farmer owner/farmer" 2 "Farm worker" 3 "Public or health service worker (non-prof)" 4 "Professional (i.e. doctor, teacher, nurse)" /*
...
replace dfs_aware_spont=0 if MM2_1==2 & MM2_2==2 & MM2_3==2 & MM2_4==2 & MM2_5==2 & MM2_6==2
...
replace dfs_aware_prompt=1 if MM3_1==1 | MM3_2==1 | MM3_3==1 | MM3_4==1 | MM3_5==1 | MM3_6==1
replace dfs_aware_prompt=0 if MM3_1==2 & MM3_2==2 & MM3_3==2 & MM3_4==2 & MM3_5==2 & MM3_6==2
la var dfs_aware_prompt "person could recall name of any DFS provider when prompted with the provider's name(MM3_1-6)"
...
gen dfs_aware_radio=.
replace dfs_aware_radio=1 if MM4_1==1 | MM4_2==1 | MM4_3==1 | MM4_4==1 | MM4_5==1 | MM4_6==1
replace dfs_aware_radio=0 if MM4_1!=1 & MM4_2!=1 & MM4_3!=1 & MM4_4!=1 & MM4_5!=1 & MM4_6!=1
replace dfs_aware_radio=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_radio "person first learned about any DFS provider from radio (MM4_1-6)"

gen dfs_aware_tv=.
replace dfs_aware_tv=1 if MM4_1==2 | MM4_2==2 | MM4_3==2 | MM4_4==2 | MM4_5==2 | MM4_6==2
replace dfs_aware_tv=0 if MM4_1!=2 & MM4_2!=2 & MM4_3!=2 & MM4_4!=2 & MM4_5!=2 & MM4_6!=2
replace dfs_aware_tv=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_tv "person first learned about any DFS provider from television (MM4_1-6)"

gen dfs_aware_billboard=.
replace dfs_aware_billboard=1 if MM4_1==3 | MM4_2==3 | MM4_3==3 | MM4_4==3 | MM4_5==3 | MM4_6==3
replace dfs_aware_billboard=0 if MM4_1!=3 & MM4_2!=3 & MM4_3!=3 & MM4_4!=3 & MM4_5!=3 & MM4_6!=3
replace dfs_aware_billboard=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_billboard "person first learned about any DFS provider from a billboard/poster (MM4_1-6)"

gen dfs_aware_newspaper=.
replace dfs_aware_newspaper=1 if MM4_1==4 | MM4_2==4 | MM4_3==4 | MM4_4==4 | MM4_5==4 | MM4_6==4
replace dfs_aware_newspaper=0 if MM4_1!=4 & MM4_2!=4 & MM4_3!=4 & MM4_4!=4 & MM4_5!=4 & MM4_6!=4
replace dfs_aware_newspaper=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_newspaper "person first learned about any DFS provider from a newspaper/magazine (MM4_1-6)"

gen dfs_aware_household=. 
replace dfs_aware_household=1 if MM4_1==5 | MM4_2==5 | MM4_3==5 | MM4_4==5 | MM4_5==5 | MM4_6==5
replace dfs_aware_household=0 if MM4_1!=5 & MM4_2!=5 & MM4_3!=5 & MM4_4!=5 & MM4_5!=5 & MM4_6!=5
replace dfs_aware_household=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_household "person first learned about any DFS provider from a fam member in their household (MM4_1-6)"

gen dfs_aware_otherfam=.
replace dfs_aware_otherfam=1 if MM4_1==6 | MM4_2==6 | MM4_3==6 | MM4_4==6 | MM4_5==5 | MM4_6==6
replace dfs_aware_otherfam=0 if MM4_1!=6 & MM4_2!=6 & MM4_3!=6 & MM4_4!=6 & MM4_5!=5 & MM4_6!=6
replace dfs_aware_otherfam=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_otherfam "person first learned about any DFS provider from a fam member in another household (MM4_1-6)"

gen dfs_aware_friend=.
replace dfs_aware_friend=1 if MM4_1==7 | MM4_2==7 | MM4_3==7 | MM4_4==7 | MM4_5==7 | MM4_6==7
replace dfs_aware_friend=0 if MM4_1!=7 & MM4_2!=7 & MM4_3!=7 & MM4_4!=7 & MM4_5!=7 & MM4_6!=7
replace dfs_aware_friend=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_friend "person first learned about any DFS provider from a friend, neighbor, or other relative (MM4_1-6)"

gen dfs_aware_workmate=.
replace dfs_aware_workmate=1 if MM4_1==8 | MM4_2==8 | MM4_3==8 | MM4_4==8 | MM4_5==8 | MM4_6==8
replace dfs_aware_workmate=0 if MM4_1!=8 & MM4_2!=8 & MM4_3!=8 & MM4_4!=8 & MM4_5!=8 & MM4_6!=8
replace dfs_aware_workmate=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_workmate "person first learned about any DFS provider from a workmate or business partner (MM4_1-6)"

gen dfs_aware_cust=.
replace dfs_aware_cust=1 if MM4_1==9 | MM4_2==9 | MM4_3==9 | MM4_4==9 | MM4_5==9 | MM4_6==9
replace dfs_aware_cust=0 if MM4_1!=9 & MM4_2!=9 & MM4_3!=9 & MM4_4!=9 & MM4_5!=9 & MM4_6!=9
replace dfs_aware_cust=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_cust "person first learned about any DFS provider from a customer of their business (MM4_1-6)"

gen dfs_aware_admin=.
replace dfs_aware_admin=1 if MM4_1==10 | MM4_2==10 | MM4_3==10 | MM4_4==10 | MM4_5==10 | MM4_6==10
replace dfs_aware_admin=0 if MM4_1!=10 & MM4_2!=10 & MM4_3!=10 & MM4_4!=10 & MM4_5!=10 & MM4_6!=10
replace dfs_aware_admin=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_admin "person first learned about any DFS provider from elected/administrative officials (MM4_1-6)"

gen dfs_aware_bankemp=.
replace  dfs_aware_bankemp=1 if MM4_1==11 | MM4_2==11 | MM4_3==11 | MM4_4==11 | MM4_5==11 | MM4_6==11
replace  dfs_aware_bankemp=0 if MM4_1!=11 & MM4_2!=11 & MM4_3!=11 & MM4_4!=11 & MM4_5!=11 & MM4_6!=11
replace  dfs_aware_bankemp=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var  dfs_aware_bankemp "person first learned about any DFS provider from a bank/MFI employee (MM4_1-6)"

gen dfs_aware_fingroup=.
replace dfs_aware_fingroup=1 if MM4_1==12 | MM4_2==12 | MM4_3==12 | MM4_4==12 | MM4_5==12 | MM4_6==12
replace dfs_aware_fingroup=0 if MM4_1!=12 & MM4_2!=12 & MM4_3!=12 & MM4_4!=12 & MM4_5!=12 & MM4_6!=12
replace dfs_aware_fingroup=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_fingroup "person first learned about any DFS provider from informal financial group (MM4_1-6)"

gen dfs_aware_agent=.
replace dfs_aware_agent=1 if MM4_1==13 | MM4_2==13 | MM4_3==13 | MM4_4==13 | MM4_5==13 | MM4_6==13
replace dfs_aware_agent=0 if MM4_1!=13 & MM4_2!=13 & MM4_3!=13 & MM4_4!=13 & MM4_5!=13 & MM4_6!=13
replace dfs_aware_agent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_agent "person first learned about any DFS provider from transactional DFS agent (MM4_1-6)"

gen dfs_aware_fieldagent=.
replace dfs_aware_fieldagent=1 if MM4_1==14 | MM4_2==14 | MM4_3==14 | MM4_4==14 | MM4_5==14 | MM4_6==14
replace dfs_aware_fieldagent=0 if MM4_1!=14 & MM4_2!=14 & MM4_3!=14 & MM4_4!=14 & MM4_5!=14 & MM4_6!=14
replace dfs_aware_fieldagent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_fieldagent "person first learned about any DFS provider from a DFS field agent/promoter(MM4_1-6)"

gen dfs_aware_sms=.
replace dfs_aware_sms=1 if MM4_1==15 | MM4_2==15 | MM4_3==15 | MM4_4==15 | MM4_5==15 | MM4_6==15
replace dfs_aware_sms=0 if MM4_1!=15 & MM4_2!=15 & MM4_3!=15 & MM4_4!=15 & MM4_5!=15 & MM4_6!=15
replace dfs_aware_sms=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_sms "person first learned about any DFS provider from a SMS alert from provider (MM4_1-6)"

gen dfs_aware_event=.
replace dfs_aware_event=1 if MM4_1==16 | MM4_2==16 | MM4_3==16 | MM4_4==16 | MM4_5==16 | MM4_6==16
replace dfs_aware_event=0 if MM4_1!=16 & MM4_2!=16 & MM4_3!=16 & MM4_4!=16 & MM4_5!=16 & MM4_6!=16
replace dfs_aware_event=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_event "person first learned about any DFS provider from street event, bus, announcer (MM4_1-6)"

gen dfs_aware_other=.
replace dfs_aware_other=1 if MM4_1==17 | MM4_2==17 | MM4_3==17 | MM4_4==17 | MM4_5==17 | MM4_6==17
replace dfs_aware_other=0 if MM4_1!=17 & MM4_2!=17 & MM4_3!=17 & MM4_4!=17 & MM4_5!=17 & MM4_6!=17
replace dfs_aware_other=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==.
la var dfs_aware_other "person first learned about any DFS provider from other source (MM4_1-6)"
...
gen dfs_adopt=.
replace dfs_adopt=1 if MM5_1==1 | MM5_2==1 | MM5_3==1 | MM5_4==1 | MM5_5==1 | MM5_6==1
replace dfs_adopt=0 if MM5_1!=1 & MM5_2!=1 & MM5_3!=1 & MM5_4!=1 & MM5_5!=1 & MM5_6!=1 
replace dfs_adopt=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==.
la var dfs_adopt "person has ever used DFS for any financial activity (MM5_2-6)"
...
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM7_1-6)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if MM8_1==1 | MM8_2==1 | MM8_3==1 | MM8_4==1 | MM8_5==1 | MM8_6==1
replace dfs_regacct=0 if MM8_1!=1 & MM8_2!=1 & MM8_3!=1 & MM8_4!=1 & MM8_5!=1 & MM8_6!=1
replace dfs_regacct=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==.
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM15_1_1==1 | MM15_2_1==1 | MM15_3_1==1 | MM15_4_1==1 | MM15_5_1==1 | MM15_6_1==1
replace dfs_access_otc=0 if MM15_1_1!=1 & MM15_2_1!=1 & MM15_3_1!=1 & MM15_4_1!=1 & MM15_5_1!=1 & MM15_6_1!=1
replace dfs_access_otc=. if MM15_1_1==. & MM15_2_1==. & MM15_3_1==. & MM15_4_1==. & MM15_5_1==. & MM15_6_1==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM15_1_1 to 15_6_1)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM15_1_2==1 | MM15_2_2==1 | MM15_3_2==1 | MM15_4_2==1 | MM15_5_2==1 | MM15_6_2==1
replace dfs_access_fam=0 if MM15_1_2!=1 & MM15_2_2!=1 & MM15_3_2!=1 & MM15_4_2!=1 & MM15_5_2!=1 & MM15_6_2!=1
replace dfs_access_fam=. if MM15_1_2==. & MM15_2_2==. & MM15_3_2==. & MM15_4_2==. & MM15_5_2==. & MM15_6_2==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM15_1_2 to 15_6_2)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM15_1_3==1 | MM15_2_3==1 | MM15_3_3==1 | MM15_4_3==1 | MM15_5_3==1 | MM15_6_3==1
replace dfs_access_nonhh=0 if MM15_1_3!=1 & MM15_2_3!=1 & MM15_3_3!=1 & MM15_4_3!=1 & MM15_5_3!=1 & MM15_6_3!=1
replace dfs_access_nonhh=. if MM15_1_3==. & MM15_2_3==. & MM15_3_3==. & MM15_4_3==. & MM15_5_3==. & MM15_6_3==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM15_1_3 to 15_6_3)"

//Account of a workmate or a business partner 
gen dfs_access_work=.
replace dfs_access_work=1 if MM15_1_4==1 | MM15_2_4==1 | MM15_3_4==1 | MM15_4_4==1 | MM15_5_4==1 | MM15_6_4==1
replace dfs_access_work=0 if MM15_1_4!=1 & MM15_2_4!=1 & MM15_3_4!=1 & MM15_4_4!=1 & MM15_5_4!=1 & MM15_6_4!=1
replace dfs_access_work=. if MM15_1_4==. & MM15_2_4==. & MM15_3_4==. & MM15_4_4==. & MM15_5_4==. & MM15_6_4==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM15_1_4 to 15_6_4)" 

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM15_1_5==1 | MM15_2_5==1 | MM15_3_5==1 | MM15_4_5==1 | MM15_5_5==1 | MM15_6_5==1
replace dfs_access_ownacct=0 if MM15_1_5!=1 & MM15_2_5!=1 & MM15_3_5!=1 & MM15_4_5!=1 & MM15_5_5!=1 & MM15_6_5!=1
replace dfs_access_ownacct=. if MM15_1_5==. & MM15_2_5==. & MM15_3_5==. & MM15_4_5==. & MM15_5_5==. & MM15_6_5==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM15_1_5 to 15_6_5)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM15_1_6==1 | MM15_2_6==1 | MM15_3_6==1 | MM15_4_6==1 | MM15_5_6==1 | MM15_6_6==1
replace dfs_access_other=0 if MM15_1_6!=1 & MM15_2_6!=1 & MM15_3_6!=1 & MM15_4_6!=1 & MM15_5_6!=1 & MM15_6_6!=1
replace dfs_access_other=. if MM15_1_6==. & MM15_2_6==. & MM15_3_6==. & MM15_4_6==. & MM15_5_6==. & MM15_6_6==.
la var dfs_access_other "person usually accesses DFS in an other way (MM15_1_6 to 15_6_6)"


**MLL: adding new variables; needs to be checked


*MLL: attempting to generate variable for whether the person has received remittances
//Supplement income with remittances:
...
count if rec_remit==. //only two obs missing

sum rec_remit //13% of population receive remittances
...
save "R:\Project\EPAR\Working Files\317 - Gender and DFS Adoption\DTAs\W2\Kenya_W2_Clean.dta", replace
