...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Tanzania Financial Inclusion Insights Wave 2 data set.
...
*-----------
*This Master do.file constructs selected sociodemogaphic and mobile money uptake outcome variables from the Tanzania Financial Inclusion Insights Wave 2 data set.
*After downloading the "FSP_Final_Tanzania_w2_12182014(public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Tanzania_w2_12182014(public).xlsx", sheet("FSP_Final_Tanzania_w2_12182014("), firstrow
save "filepath for location where you want to save dta file/Tanzania_Wave2_Stata.dta", replace
clear
...
*Tanzania*
**********
use "$input\Tanzania_Wave2_Stata.dta"

*********************************************
** RENAME VARIABLES TO BE USED IN ANALYSIS **
*********************************************
//Generate dummy variable for Tanzania (for when appending to other files) 
gen Tanzania=1 
...
//Location Variables
rename A1 region
la var region "residential region of respondent (A1)"
rename A2 district
la var district "residential district of respondent" // refer to codebook (R:\Project\EPAR\FII Datasets\Tanzania Wave 2 Excel)for labels
rename A4 urban_rural //1=urban, 2=rural
la var urban_rural "settlement size (1=urban 2=rural) (A4)"
...
la var n_household "number of members in household, incl. adults and children (DL26_1)"
...
la var dfs_recfam_reg "person has used DFS to receive money from fam/friends for reg support or emergency (MM19_13)"
rename MM19_14 dfs_recfam_noreg
la var dfs_recfam_noreg "person has used DFS to receive money from fam/friends for other reason or no reason (MM19_14)"
...
la var dfs_savepurchase "person has used DFS to save for future purchases or payment (MM19_24)"
rename MM19_25 dfs_savepen
la var dfs_savepen "person has used DFS to save for pension (MM19_25)"
rename MM19_26 dfs_saveunknown
la var dfs_saveunknown "person has used DFS to set aside money just in case, no particular purpose (MM19_26)"
rename MM19_27 dfs_invest
la var dfs_invest "person has used DFS to invest, buy stock or shares (MM19_27)"
...
la var dfs_agent_same "person tends to use same MM agent most of the time (see codebook for labels) (MM23)"
...
la var dfs_prob_who "when an MM transaction goes wrong, who do you go to to help you resolve it? (see codebook for labels) (MM43)"
...
//MLL:Look at this again - includes DL4_1... (supplemental income) and if no job, where do you get $ (DL5)
gen rec_support=.
...
gen dfs_aware_spont=.
replace dfs_aware_spont=1 if MM2_1==1 | MM2_2==1 | MM2_3==1 | MM2_4==1 | MM2_5==1
replace dfs_aware_spont=0 if MM2_1==2 & MM2_2==2 & MM2_3==2 & MM2_4==2 & MM2_5==2
la var dfs_aware_spont "person could spontaneously recall name of any DFS provider (MM2_1-5)"

**PROMPTED RECALL of DFS providers
gen dfs_aware_prompt=.
replace dfs_aware_prompt=1 if MM3_1==1 | MM3_2==1 | MM3_3==1 | MM3_4==1
replace dfs_aware_prompt=0 if MM3_1==2 & MM3_2==2 & MM3_3==2 & MM3_4==2
la var dfs_aware_prompt "person could recall name of any DFS provider when prompted with the provider's name(MM3_1-5)"
//Note that individuals were not asked about names of providers they already spontaneously recalled
...
gen dfs_aware_radio=.
replace dfs_aware_radio=1 if MM4_1==1 | MM4_2==1 | MM4_3==1 | MM4_4==1 | MM4_5==1
replace dfs_aware_radio=0 if MM4_1!=1 & MM4_2!=1 & MM4_3!=1 & MM4_4!=1
replace dfs_aware_radio=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_radio "person first learned about any DFS provider from radio (MM4_1-5)"

gen dfs_aware_tv=.
replace dfs_aware_tv=1 if MM4_1==2 | MM4_2==2 | MM4_3==2 | MM4_4==2 | MM4_5==2
replace dfs_aware_tv=0 if MM4_1!=2 & MM4_2!=2 & MM4_3!=2 & MM4_4!=2 & MM4_5!=2
replace dfs_aware_tv=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_tv "person first learned about any DFS provider from television (MM4_1-5)"

gen dfs_aware_billboard=.
replace dfs_aware_billboard=1 if MM4_1==3 | MM4_2==3 | MM4_3==3 | MM4_4==3 | MM4_5==3
replace dfs_aware_billboard=0 if MM4_1!=3 & MM4_2!=3 & MM4_3!=3 & MM4_4!=3 & MM4_5!=3
replace dfs_aware_billboard=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_billboard "person first learned about any DFS provider from a billboard/poster (MM4_1-5)"

gen dfs_aware_newspaper=.
replace dfs_aware_newspaper=1 if MM4_1==4 | MM4_2==4 | MM4_3==4 | MM4_4==4 | MM4_5==4
replace dfs_aware_newspaper=0 if MM4_1!=4 & MM4_2!=4 & MM4_3!=4 & MM4_4!=4 & MM4_5!=4
replace dfs_aware_newspaper=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_newspaper "person first learned about any DFS provider from a newspaper/magazine (MM4_1-5)"

gen dfs_aware_household=. 
replace dfs_aware_household=1 if MM4_1==5 | MM4_2==5 | MM4_3==5 | MM4_4==5 | MM4_5==5
replace dfs_aware_household=0 if MM4_1!=5 & MM4_2!=5 & MM4_3!=5 & MM4_4!=5 & MM4_5!=5
replace dfs_aware_household=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_household "person first learned about any DFS provider from a fam member in their household (MM4_1-5)"

gen dfs_aware_otherfam=.
replace dfs_aware_otherfam=1 if MM4_1==6 | MM4_2==6 | MM4_3==6 | MM4_4==6 | MM4_5==6
replace dfs_aware_otherfam=0 if MM4_1!=6 & MM4_2!=6 & MM4_3!=6 & MM4_4!=6 & MM4_5!=6
replace dfs_aware_otherfam=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_otherfam "person first learned about any DFS provider from a fam member in another household (MM4_1-5)"

gen dfs_aware_friend=.
replace dfs_aware_friend=1 if MM4_1==7 | MM4_2==7 | MM4_3==7 | MM4_4==7 | MM4_5==7
replace dfs_aware_friend=0 if MM4_1!=7 & MM4_2!=7 & MM4_3!=7 & MM4_4!=7 & MM4_5!=7
replace dfs_aware_friend=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_friend "person first learned about any DFS provider from a friend, neighbor, or other relative (MM4_1-5)"

gen dfs_aware_workmate=.
replace dfs_aware_workmate=1 if MM4_1==8 | MM4_2==8 | MM4_3==8 | MM4_4==8 | MM4_5==8
replace dfs_aware_workmate=0 if MM4_1!=8 & MM4_2!=8 & MM4_3!=8 & MM4_4!=8 & MM4_5!=8
replace dfs_aware_workmate=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_workmate "person first learned about any DFS provider from a workmate or business partner (MM4_1-5)"

gen dfs_aware_cust=.
replace dfs_aware_cust=1 if MM4_1==9 | MM4_2==9 | MM4_3==9 | MM4_4==9 | MM4_5==9
replace dfs_aware_cust=0 if MM4_1!=9 & MM4_2!=9 & MM4_3!=9 & MM4_4!=9 & MM4_5!=9
replace dfs_aware_cust=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_cust "person first learned about any DFS provider from a customer of their business (MM4_1-5)"

gen dfs_aware_admin=.
replace dfs_aware_admin=1 if MM4_1==10 | MM4_2==10 | MM4_3==10 | MM4_4==10 | MM4_5==10
replace dfs_aware_admin=0 if MM4_1!=10 & MM4_2!=10 & MM4_3!=10 & MM4_4!=10 & MM4_5!=10
replace dfs_aware_admin=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_admin "person first learned about any DFS provider from elected/administrative officials (MM4_1-5)"

gen dfs_aware_bankemp=.
replace  dfs_aware_bankemp=1 if MM4_1==11 | MM4_2==11 | MM4_3==11 | MM4_4==11 | MM4_5==11
replace  dfs_aware_bankemp=0 if MM4_1!=11 & MM4_2!=11 & MM4_3!=11 & MM4_4!=11 & MM4_5!=11
replace  dfs_aware_bankemp=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var  dfs_aware_bankemp "person first learned about any DFS provider from a bank/MFI employee (MM4_1-5)"

gen dfs_aware_fingroup=.
replace dfs_aware_fingroup=1 if MM4_1==12 | MM4_2==12 | MM4_3==12 | MM4_4==12 | MM4_5==12
replace dfs_aware_fingroup=0 if MM4_1!=12 & MM4_2!=12 & MM4_3!=12 & MM4_4!=12 & MM4_5!=12
replace dfs_aware_fingroup=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_fingroup "person first learned about any DFS provider from informal financial group (MM4_1-5)"

gen dfs_aware_agent=.
replace dfs_aware_agent=1 if MM4_1==13 | MM4_2==13 | MM4_3==13 | MM4_4==13 | MM4_5==13
replace dfs_aware_agent=0 if MM4_1!=13 & MM4_2!=13 & MM4_3!=13 & MM4_4!=13 & MM4_5!=13
replace dfs_aware_agent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_agent "person first learned about any DFS provider from transactional DFS agent (MM4_1-5)"

gen dfs_aware_fieldagent=.
replace dfs_aware_fieldagent=1 if MM4_1==14 | MM4_2==14 | MM4_3==14 | MM4_4==14 | MM4_5==14
replace dfs_aware_fieldagent=0 if MM4_1!=14 & MM4_2!=14 & MM4_3!=14 & MM4_4!=14 & MM4_5!=14
replace dfs_aware_fieldagent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_fieldagent "person first learned about any DFS provider from a DFS field agent/promoter(MM4_1-5)"

gen dfs_aware_sms=.
replace dfs_aware_sms=1 if MM4_1==15 | MM4_2==15 | MM4_3==15 | MM4_4==15 | MM4_5==15
replace dfs_aware_sms=0 if MM4_1!=15 & MM4_2!=15 & MM4_3!=15 & MM4_4!=15 & MM4_5!=15
replace dfs_aware_sms=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_sms "person first learned about any DFS provider from a SMS alert from provider (MM4_1-5)"

gen dfs_aware_event=.
replace dfs_aware_event=1 if MM4_1==16 | MM4_2==16 | MM4_3==16 | MM4_4==16 | MM4_5==16
replace dfs_aware_event=0 if MM4_1!=16 & MM4_2!=16 & MM4_3!=16 & MM4_4!=16 & MM4_5!=16
replace dfs_aware_event=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_event "person first learned about any DFS provider from street event, bus, announcer (MM4_1-5)"

gen dfs_aware_other=.
replace dfs_aware_other=1 if MM4_1==17 | MM4_2==17 | MM4_3==17 | MM4_4==17 | MM4_5==17
replace dfs_aware_other=0 if MM4_1!=17 & MM4_2!=17 & MM4_3!=17 & MM4_4!=17 & MM4_5!=17
replace dfs_aware_other=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==.
la var dfs_aware_other "person first learned about any DFS provider from other source (MM4_1-5)"
...
gen dfs_adopt=.
replace dfs_adopt=1 if MM5_1==1 | MM5_2==1 | MM5_3==1 | MM5_4==1 | MM5_5==1
replace dfs_adopt=0 if MM5_1!=1 & MM5_2!=1 & MM5_3!=1 & MM5_4!=1 & MM5_5!=1
replace dfs_adopt=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==.
la var dfs_adopt "person has ever used DFS for any financial activity (MM5_2-5)"
...
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM7_1-5)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if MM8_1==1 | MM8_2==1 | MM8_3==1 | MM8_4==1 | MM8_5==1
replace dfs_regacct=0 if MM8_1!=1 & MM8_2!=1 & MM8_3!=1 & MM8_4!=1 & MM8_5!=1
replace dfs_regacct=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==.
la var dfs_regacct "person has a registered account with any DFS provider (MM8_1-5)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM15_1==1 | MM15_2==1 | MM15_3==1 | MM15_4==1 | MM15_5==1
replace dfs_access_otc=0 if MM15_1!=1 & MM15_2!=1 & MM15_3!=1 & MM15_4!=1 & MM15_5!=1
replace dfs_access_otc=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM15_1-5)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM15_1==2 | MM15_2==2 | MM15_3==2 | MM15_4==2 | MM15_5==2
replace dfs_access_fam=0 if MM15_1!=2 & MM15_2!=2 & MM15_3!=2 & MM15_4!=2 & MM15_5!=2
replace dfs_access_fam=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM15_1-5)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM15_1==3 | MM15_2==3 | MM15_3==3 | MM15_4==3 | MM15_5==3
replace dfs_access_nonhh=0 if MM15_1!=3 & MM15_2!=3 & MM15_3!=3 & MM15_4!=3 & MM15_5!=3
replace dfs_access_nonhh=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM15_1-5)"

//Account of a workmate or a business partner
gen dfs_access_work=.
replace dfs_access_work=1 if MM15_1==4 | MM15_2==4 | MM15_3==4 | MM15_4==4 | MM15_5==4
replace dfs_access_work=0 if MM15_1!=4 & MM15_2!=4 & MM15_3!=4 & MM15_4!=4 & MM15_5!=4
replace dfs_access_work=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM15_1-5)"

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM15_1==5 | MM15_2==5 | MM15_3==5 | MM15_4==5 | MM15_5==5
replace dfs_access_ownacct=0 if MM15_1!=5 & MM15_2!=5 & MM15_3!=5 & MM15_4!=5 & MM15_5!=5
replace dfs_access_ownacct=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM15_1-5)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM15_1==6 | MM15_2==6 | MM15_3==6 | MM15_4==6 | MM15_5==6
replace dfs_access_other=0 if MM15_1!=6 & MM15_2!=6 & MM15_3!=6 & MM15_4!=6 & MM15_5!=6
replace dfs_access_other=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==.
la var dfs_access_other "person usually accesses DFS in an other way (MM15_1-6)"
...
count if rec_remit==. //11 obs missing

sum rec_remit //10.6% of obs report receiving remittances
...
*MLL: This is a little weird - some people answered a 3 or 4 for an advanced skill but say they do not make phone calls and/or text....
count if (mobileskills_call==0 | mobileskills_text==0) & mobileskills_advanced==1 //134
*/
...
save "R:\Project\EPAR\Working Files\317 - Gender and DFS Adoption\DTAs\W2\Tanzania_W2_Clean.dta", replace
