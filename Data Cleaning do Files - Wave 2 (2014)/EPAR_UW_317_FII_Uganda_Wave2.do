...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Uganda Financial Inclusion Insights Wave 2 data set.
...
*After downloading the "FSP_Final_Uganda_W2_10312015(public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Uganda_W2_10312015(public).xlsx", sheet("FSP_Final_Uganda_W2_10312015(pu"), firstrow
save "filepath for location where you want to save dta file/Uganda_Wave2_Stata.dta", replace
clear
...
*Uganda*
********
use "$input\Uganda_Wave2_Stata.dta"
...
rename DG3 marital_status //refer to codebook (R:\Project\EPAR\FII Datasets\Uganda Wave 2 Excel) for labels, created dummy var below
...
la var n_household "number of members in household, incl. adults and children (DL11)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM15_1==1 | MM15_2==1 | MM15_3==1 | MM15_4==1 | MM15_5==1 | MM15_6==1
replace dfs_access_otc=0 if MM15_1!=1 & MM15_2!=1 & MM15_3!=1 & MM15_4!=1 & MM15_5!=1 & MM15_6!=1
replace dfs_access_otc=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM15_1-6)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM15_1==2 | MM15_2==2 | MM15_3==2 | MM15_4==2 | MM15_5==2 | MM15_6==2
replace dfs_access_fam=0 if MM15_1!=2 & MM15_2!=2 & MM15_3!=2 & MM15_4!=2 & MM15_5!=2 & MM15_6!=2
replace dfs_access_fam=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM15_1-6)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM15_1==3 | MM15_2==3 | MM15_3==3 | MM15_4==3 | MM15_5==3 | MM15_6==3
replace dfs_access_nonhh=0 if MM15_1!=3 & MM15_2!=3 & MM15_3!=3 & MM15_4!=3 & MM15_5!=3 & MM15_6!=3
replace dfs_access_nonhh=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM15_1-6)"

//Account of a workmate or a business partner
gen dfs_access_work=.
replace dfs_access_work=1 if MM15_1==4 | MM15_2==4 | MM15_3==4 | MM15_4==4 | MM15_5==4 | MM15_6==4
replace dfs_access_work=0 if MM15_1!=4 & MM15_2!=4 & MM15_3!=4 & MM15_4!=4 & MM15_5!=4 & MM15_6!=4
replace dfs_access_work=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM15_1-6)"

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM15_1==5 | MM15_2==5 | MM15_3==5 | MM15_4==5 | MM15_5==5 | MM15_6==5
replace dfs_access_ownacct=0 if MM15_1!=5 & MM15_2!=5 & MM15_3!=5 & MM15_4!=5 & MM15_5!=5 & MM15_6!=5
replace dfs_access_ownacct=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM15_1-6)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM15_1==6 | MM15_2==6 | MM15_3==6 | MM15_4==6 | MM15_5==6 | MM15_6==6
replace dfs_access_other=0 if MM15_1!=6 & MM15_2!=6 & MM15_3!=6 & MM15_4!=6 & MM15_5!=6 & MM15_6!=6
replace dfs_access_other=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==.
...
sum rec_remit //8.6% of obs report receiving remittances
...
count if (TDL2_4==3 | TDL2_4==4) & TDL2_5<3 //60 people can send text messages but cannot respond to text messages from other people -- these people still have a 1 for mobileskills_text
...
count if (mobileskills_call==0 | mobileskills_text==0) & mobileskills_advanced==1 //385
 */
...
save "R:\Project\EPAR\Working Files\317 - Gender and DFS Adoption\DTAs\W2\Uganda_W2_Clean.dta", replace
