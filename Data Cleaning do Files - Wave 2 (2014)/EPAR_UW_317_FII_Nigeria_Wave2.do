...
*Title/Purpose 	: This do.file was developed by the Evans School Policy Analysis & Research Group (EPAR) 
				  ...
				  using the Nigeria Financial Inclusion Insights Wave 2 data set.
...
*-----------
*This Master do.file constructs selected sociodemogaphic and mobile money uptake outcome variables from the Nigeria Financial Inclusion Insights Wave 2 data set.
*After downloading the "FSP_Final_Nigeria_w2_11182014(public).xlsx" data file from Intermedia, we convert it to Stata .dta format for analysis. 
...
import excel using "filepath for location where you downloaded raw data/FSP_Final_Nigeria_w2_11182014(public).xlsx", firstrow
save "filepath for location where you want to save dta file/Nigeria_Wave2_Stata.dta", replace
clear
...
*Nigeria*
*******
use "$input\Nigeria_Wave2_Stata.dta"

*********************************************
** RENAME VARIABLES TO BE USED IN ANALYSIS **
*********************************************
//Generate dummy variable for Nigeria (for when appending to other files) 
gen Nigeria=1 
...
//Location Variables
rename STATE state
la var state "residential state of respondent"
rename Regions region
la var region "residential region of respondent"

rename Location urban_rural //1=urban, 2=rural
...
rename DL2 primary_job // refer to FII codebook for labels -- may want to make dummy for farmer -- NOT WORKING, CHECK
la var primary_job "individual's primary job (see codebook for labels) (DL2)"
rename DL11 n_household
la var n_household "number of members in household (DL11)"
...
la var highest_ed "highest level of education (DG4)"
	label define highest_edl 1 "No formal education" 2 "Primary education not complete" 3 "Primary education complete" /*
		*/ 4 "Some secondary" 5 "Secondary education complete" 6 "Some secondary vocational training" /*
		*/ 7 "Secondary vocational training complete" 8 "Some diploma" 9 "Diploma complete" 10 "Some college/university" /* 
		*/ 11 "Complete university degree" 12 "Post-graduate university degree" 13 "Koranic school/Madrassa" 14 "Other (specify)" 15 "DK/Refused"
...
la var phone_access "person uses mobile phone belonging to someone else by borrowing or paying for its use (MT1)"
rename MT7 sim_own
...
**Transport to agent
rename MM25 dfs_agent_dist //see codebook for labels
la var dfs_agent_dist "distance of closest MM agent from where they live (see codebook for labels)(MM25)"
rename MM27 dfs_agent_transway
la var dfs_agent_transway "method of transport to get to nearest MM agent (see codebook for labels) (MM27)"
rename MM28 dfs_agent_transtime
la var dfs_agent_transtime "length of time to get to nearest MM agent (see codebook for labels) (MM28)"
...
la var dfs_agentiss_netdown "agent issue: GSM or mobile network down (MM30_8)"
...
** Level of satisfaction before, after bank account/DFS
...
*/ dfs_withdraw dfs_airtime dfs_payschool dfs_paymed dfs_payelectric dfs_paywater dfs_paysolar dfs_paytv /*
...
gen dfs_aware_spont=.
replace dfs_aware_spont=1 if MM2_1==1 | MM2_2==1 | MM2_3==1 | MM2_4==1 | MM2_5==1 | MM2_6==1 | MM2_7==1 | MM2_8==1 | MM2_9==1 | MM2_10==1 | MM2_11==1 | MM2_12==1 | MM2_13==1 | MM2_14==1
replace dfs_aware_spont=0 if MM2_1==2 & MM2_2==2 & MM2_3==2 & MM2_4==2 & MM2_5==2 & MM2_6==2 & MM2_7==2 & MM2_8==2 & MM2_9==2 & MM2_10==2 & MM2_11==2 & MM2_12==2 & MM2_13==2 & MM2_14==2
la var dfs_aware_spont "person could spontaneously recall name of any DFS provider (MM2_1-14)"

**PROMPTED RECALL of DFS providers
gen dfs_aware_prompt=.
replace dfs_aware_prompt=1 if MM3_1==1 | MM3_2==1 | MM3_3==1 | MM3_4==1 | MM3_5==1 | MM3_6==1 | MM3_7==1 | MM3_8==1 | MM3_9==1 | MM3_10==1 | MM3_11==1 | MM3_12==1 | MM3_13==1
replace dfs_aware_prompt=0 if MM3_1==2 & MM3_2==2 & MM3_3==2 & MM3_4==2 & MM3_5==2 & MM3_6==2 & MM3_7==2 & MM3_8==2 & MM3_9==2 & MM3_10==2 & MM3_11==2 & MM3_12==2 & MM3_13==2
la var dfs_aware_prompt "person could recall name of any DFS provider when prompted with name(MM3_1-14)"
...
gen dfs_aware_radio=.
replace dfs_aware_radio=1 if MM4_1==1 | MM4_2==1 | MM4_3==1 | MM4_4==1 | MM4_5==1 | MM4_6==1 | MM4_7==1 | MM4_8==1 | MM4_9==1 | MM4_10==1 | MM4_11==1 | MM4_12==1 | MM4_13==1 | MM4_14==1
replace dfs_aware_radio=0 if MM4_1!=1 & MM4_2!=1 & MM4_3!=1 & MM4_4!=1 & MM4_5!=1 & MM4_6!=1 & MM4_7!=1 & MM4_8!=1 & MM4_9!=1 & MM4_10!=1 & MM4_11!=1 & MM4_12!=1 & MM4_13!=1 & MM4_14!=1
replace dfs_aware_radio=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_radio "person first learned about any DFS provider from radio (MM4_1-14)"

gen dfs_aware_tv=.
replace dfs_aware_tv=1 if MM4_1==2 | MM4_2==2 | MM4_3==2 | MM4_4==2 | MM4_5==2 | MM4_6==2 | MM4_7==2 | MM4_8==2 | MM4_9==2 | MM4_10==2 | MM4_11==2 | MM4_12==2 | MM4_13==2 | MM4_14==2
replace dfs_aware_tv=0 if MM4_1!=2 & MM4_2!=2 & MM4_3!=2 & MM4_4!=2 & MM4_5!=2 & MM4_6!=2 & MM4_7!=2 & MM4_8!=2 & MM4_9!=2 & MM4_10!=2 & MM4_11!=2 & MM4_12!=2 & MM4_13!=2 & MM4_14!=2
replace dfs_aware_tv=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_tv "person first learned about any DFS provider from television (MM4_1-14)"

gen dfs_aware_billboard=.
replace dfs_aware_billboard=1 if MM4_1==3 | MM4_2==3 | MM4_3==3 | MM4_4==3 | MM4_5==3 | MM4_6==3 | MM4_7==3 | MM4_8==3 | MM4_9==3 | MM4_10==3 | MM4_11==3 | MM4_12==3 | MM4_13==3 | MM4_14==3
replace dfs_aware_billboard=0 if MM4_1!=3 & MM4_2!=3 & MM4_3!=3 & MM4_4!=3 & MM4_5!=3 & MM4_6!=3 & MM4_7!=3 & MM4_8!=3 & MM4_9!=3 & MM4_10!=3 & MM4_11!=3 & MM4_12!=3 & MM4_13!=3 & MM4_14!=3
replace dfs_aware_billboard=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_billboard "person first learned about any DFS provider from a billboard/poster (MM4_1-14)"

gen dfs_aware_newspaper=.
replace dfs_aware_newspaper=1 if MM4_1==4 | MM4_2==4 | MM4_3==4 | MM4_4==4 | MM4_5==4 | MM4_6==4 | MM4_7==4 | MM4_8==4 | MM4_9==4 | MM4_10==4 | MM4_11==4 | MM4_12==4 | MM4_13==4 | MM4_14==4
replace dfs_aware_newspaper=0 if MM4_1!=4 & MM4_2!=4 & MM4_3!=4 & MM4_4!=4 & MM4_5!=4 & MM4_6!=4 & MM4_7!=4 & MM4_8!=4 & MM4_9!=4 & MM4_10!=4 & MM4_11!=4 & MM4_12!=4 & MM4_13!=4 & MM4_14!=4
replace dfs_aware_newspaper=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_newspaper "person first learned about any DFS provider from a newspaper/magazine (MM4_1-14)"

gen dfs_aware_household=. 
replace dfs_aware_household=1 if MM4_1==5 | MM4_2==5 | MM4_3==5 | MM4_4==5 | MM4_5==5 | MM4_6==5 | MM4_7==5 | MM4_8==5 | MM4_9==5 | MM4_10==5 | MM4_11==5 | MM4_12==5 | MM4_13==5 | MM4_14==5
replace dfs_aware_household=0 if MM4_1!=5 & MM4_2!=5 & MM4_3!=5 & MM4_4!=5 & MM4_5!=5 & MM4_6!=5 & MM4_7!=5 & MM4_8!=5 & MM4_9!=5 & MM4_10!=5 & MM4_11!=5 & MM4_12!=5 & MM4_13!=5 & MM4_14!=5
replace dfs_aware_household=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_household "person first learned about any DFS provider from a fam member in their household (MM4_1-14)"

gen dfs_aware_otherfam=.
replace dfs_aware_otherfam=1 if MM4_1==6 | MM4_2==6 | MM4_3==6 | MM4_4==6 | MM4_5==5 | MM4_6==6 | MM4_7==6 | MM4_8==6 | MM4_9==6 | MM4_10==6 | MM4_11==6 | MM4_12==6 | MM4_13==6 | MM4_14==6
replace dfs_aware_otherfam=0 if MM4_1!=6 & MM4_2!=6 & MM4_3!=6 & MM4_4!=6 & MM4_5!=5 & MM4_6!=6 & MM4_7!=6 & MM4_8!=6 & MM4_9!=6 & MM4_10!=6 & MM4_11!=6 & MM4_12!=6 & MM4_13!=6 & MM4_14!=6
replace dfs_aware_otherfam=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_otherfam "person first learned about any DFS provider from a fam member in another household (MM4_1-14)"

gen dfs_aware_friend=.
replace dfs_aware_friend=1 if MM4_1==7 | MM4_2==7 | MM4_3==7 | MM4_4==7 | MM4_5==7 | MM4_6==7 | MM4_7==7 | MM4_8==7 | MM4_9==7 | MM4_10==7 | MM4_11==7 | MM4_12==7 | MM4_13==7 | MM4_14==7
replace dfs_aware_friend=0 if MM4_1!=7 & MM4_2!=7 & MM4_3!=7 & MM4_4!=7 & MM4_5!=7 & MM4_6!=7 & MM4_7!=7 & MM4_8!=7 & MM4_9!=7 & MM4_10!=7 & MM4_11!=7 & MM4_12!=7 & MM4_13!=7 & MM4_14!=7
replace dfs_aware_friend=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_friend "person first learned about any DFS provider from a friend, neighbor, or other relative (MM4_1-14)"

gen dfs_aware_workmate=.
replace dfs_aware_workmate=1 if MM4_1==8 | MM4_2==8 | MM4_3==8 | MM4_4==8 | MM4_5==8 | MM4_6==8 | MM4_7==8 | MM4_8==8 | MM4_9==8 | MM4_10==8 | MM4_11==8 | MM4_12==8 | MM4_13==8 | MM4_14==8
replace dfs_aware_workmate=0 if MM4_1!=8 & MM4_2!=8 & MM4_3!=8 & MM4_4!=8 & MM4_5!=8 & MM4_6!=8 & MM4_7!=8 & MM4_8!=8 & MM4_9!=8 & MM4_10!=8 & MM4_11!=8 & MM4_12!=8 & MM4_13!=8 & MM4_14!=8
replace dfs_aware_workmate=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_workmate "person first learned about any DFS provider from a workmate or business partner (MM4_1-14)"

gen dfs_aware_cust=.
replace dfs_aware_cust=1 if MM4_1==9 | MM4_2==9 | MM4_3==9 | MM4_4==9 | MM4_5==9 | MM4_6==9 | MM4_7==9 | MM4_8==9 | MM4_9==9 | MM4_10==9 | MM4_11==9 | MM4_12==9 | MM4_13==9 | MM4_14==9
replace dfs_aware_cust=0 if MM4_1!=9 & MM4_2!=9 & MM4_3!=9 & MM4_4!=9 & MM4_5!=9 & MM4_6!=9 & MM4_7!=9 & MM4_8!=9 & MM4_9!=9 & MM4_10!=9 & MM4_11!=9 & MM4_12!=9 & MM4_13!=9 & MM4_14!=9
replace dfs_aware_cust=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_cust "person first learned about any DFS provider from a customer of their business (MM4_1-14)"

gen dfs_aware_admin=.
replace dfs_aware_admin=1 if MM4_1==10 | MM4_2==10 | MM4_3==10 | MM4_4==10 | MM4_5==10 | MM4_6==10 | MM4_7==10 | MM4_8==10 | MM4_9==10 | MM4_10==10 | MM4_11==10 | MM4_12==10 | MM4_13==10 | MM4_14==10
replace dfs_aware_admin=0 if MM4_1!=10 & MM4_2!=10 & MM4_3!=10 & MM4_4!=10 & MM4_5!=10 & MM4_6!=10 & MM4_7!=10 & MM4_8!=10 & MM4_9!=10 & MM4_10!=10 & MM4_11!=10 & MM4_12!=10 & MM4_13!=10 & MM4_14!=10
replace dfs_aware_admin=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_admin "person first learned about any DFS provider from elected/administrative officials (MM4_1-14)"

gen dfs_aware_bankemp=.
replace  dfs_aware_bankemp=1 if MM4_1==11 | MM4_2==11 | MM4_3==11 | MM4_4==11 | MM4_5==11 | MM4_6==11 | MM4_7==11 | MM4_8==11 | MM4_9==11 | MM4_10==11 | MM4_11==11 | MM4_12==11 | MM4_13==11 | MM4_14==11
replace  dfs_aware_bankemp=0 if MM4_1!=11 & MM4_2!=11 & MM4_3!=11 & MM4_4!=11 & MM4_5!=11 & MM4_6!=11 & MM4_7!=11 & MM4_8!=11 & MM4_9!=11 & MM4_10!=11 & MM4_11!=11 & MM4_12!=11 & MM4_13!=11 & MM4_14!=11
replace  dfs_aware_bankemp=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var  dfs_aware_bankemp "person first learned about any DFS provider from a bank/MFI employee (MM4_1-14)"

gen dfs_aware_fingroup=.
replace dfs_aware_fingroup=1 if MM4_1==12 | MM4_2==12 | MM4_3==12 | MM4_4==12 | MM4_5==12 | MM4_6==12 | MM4_7==12 | MM4_8==12 | MM4_9==12 | MM4_10==12 | MM4_11==12 | MM4_12==12 | MM4_13==12 | MM4_14==12
replace dfs_aware_fingroup=0 if MM4_1!=12 & MM4_2!=12 & MM4_3!=12 & MM4_4!=12 & MM4_5!=12 & MM4_6!=12 & MM4_7!=12 & MM4_8!=12 & MM4_9!=12 & MM4_10!=12 & MM4_11!=12 & MM4_12!=12 & MM4_13!=12 & MM4_14!=12
replace dfs_aware_fingroup=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_fingroup "person first learned about any DFS provider from informal financial group (MM4_1-14)"

gen dfs_aware_agent=.
replace dfs_aware_agent=1 if MM4_1==13 | MM4_2==13 | MM4_3==13 | MM4_4==13 | MM4_5==13 | MM4_6==13 | MM4_7==13 | MM4_8==13 | MM4_9==13 | MM4_10==13 | MM4_11==13 | MM4_12==13 | MM4_13==13 | MM4_14==13
replace dfs_aware_agent=0 if MM4_1!=13 & MM4_2!=13 & MM4_3!=13 & MM4_4!=13 & MM4_5!=13 & MM4_6!=13 & MM4_7!=13 & MM4_8!=13 & MM4_9!=13 & MM4_10!=13 & MM4_11!=13 & MM4_12!=13 & MM4_13!=13 & MM4_14!=13
replace dfs_aware_agent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_agent "person first learned about any DFS provider from transactional DFS agent (MM4_1-14)"

gen dfs_aware_fieldagent=.
replace dfs_aware_fieldagent=1 if MM4_1==14 | MM4_2==14 | MM4_3==14 | MM4_4==14 | MM4_5==14 | MM4_6==14 | MM4_7==14 | MM4_8==14 | MM4_9==14 | MM4_10==14 | MM4_11==14 | MM4_12==14 | MM4_13==14 | MM4_14==14
replace dfs_aware_fieldagent=0 if MM4_1!=14 & MM4_2!=14 & MM4_3!=14 & MM4_4!=14 & MM4_5!=14 & MM4_6!=14 & MM4_7!=14 & MM4_8!=14 & MM4_9!=14 & MM4_10!=14 & MM4_11!=14 & MM4_12!=14 & MM4_13!=14 & MM4_14!=14
replace dfs_aware_fieldagent=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_fieldagent "person first learned about any DFS provider from a DFS field agent/promoter(MM4_1-14)"

gen dfs_aware_sms=.
replace dfs_aware_sms=1 if MM4_1==15 | MM4_2==15 | MM4_3==15 | MM4_4==15 | MM4_5==15 | MM4_6==15 | MM4_7==15 | MM4_8==15 | MM4_9==15 | MM4_10==15 | MM4_11==15 | MM4_12==15 | MM4_13==15 | MM4_14==15
replace dfs_aware_sms=0 if MM4_1!=15 & MM4_2!=15 & MM4_3!=15 & MM4_4!=15 & MM4_5!=15 & MM4_6!=15 & MM4_7!=15 & MM4_8!=15 & MM4_9!=15 & MM4_10!=15 & MM4_11!=15 & MM4_12!=15 & MM4_13!=15 & MM4_14!=15
replace dfs_aware_sms=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_sms "person first learned about any DFS provider from a SMS alert from provider (MM4_1-14)"

gen dfs_aware_event=.
replace dfs_aware_event=1 if MM4_1==16 | MM4_2==16 | MM4_3==16 | MM4_4==16 | MM4_5==16 | MM4_6==16 | MM4_7==16 | MM4_8==16 | MM4_9==16 | MM4_10==16 | MM4_11==16 | MM4_12==16 | MM4_13==16 | MM4_14==16
replace dfs_aware_event=0 if MM4_1!=16 & MM4_2!=16 & MM4_3!=16 & MM4_4!=16 & MM4_5!=16 & MM4_6!=16 & MM4_7!=16 & MM4_8!=16 & MM4_9!=16 & MM4_10!=16 & MM4_11!=16 & MM4_12!=16 & MM4_13!=16 & MM4_14!=16
replace dfs_aware_event=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_event "person first learned about any DFS provider from street event, bus, announcer (MM4_1-14)"

gen dfs_aware_other=.
replace dfs_aware_other=1 if MM4_1==17 | MM4_2==17 | MM4_3==17 | MM4_4==17 | MM4_5==17 | MM4_6==17 | MM4_7==17 | MM4_8==17 | MM4_9==17 | MM4_10==17 | MM4_11==17 | MM4_12==17 | MM4_13==17 | MM4_14==17
replace dfs_aware_other=0 if MM4_1!=17 & MM4_2!=17 & MM4_3!=17 & MM4_4!=17 & MM4_5!=17 & MM4_6!=17 & MM4_7!=17 & MM4_8!=17 & MM4_9!=17 & MM4_10!=17 & MM4_11!=17 & MM4_12!=17 & MM4_13!=17 & MM4_14!=17
replace dfs_aware_other=. if MM4_1==. & MM4_2==. & MM4_3==. & MM4_4==. & MM4_5==. & MM4_6==. & MM4_7==. & MM4_8==. & MM4_9==. & MM4_10==. & MM4_11==. & MM4_12==. & MM4_13==. & MM4_14==.
la var dfs_aware_other "person first learned about any DFS provider from other source (MM4_1-14)"
...
gen dfs_adopt=.
replace dfs_adopt=1 if MM5_1==1 | MM5_2==1 | MM5_3==1 | MM5_4==1 | MM5_5==1 | MM5_6==1 | MM5_7==1 | MM5_8==1 | MM5_9==1 | MM5_10==1 | MM5_11==1 | MM5_12==1 | MM5_13==1 | MM5_14==1  
replace dfs_adopt=0 if MM5_1!=1 & MM5_2!=1 & MM5_3!=1 & MM5_4!=1 & MM5_5!=1 & MM5_6!=1 & MM5_7!=1 & MM5_8!=1 & MM5_9!=1 & MM5_10!=1 & MM5_11!=1 & MM5_12!=1 & MM5_13!=1 & MM5_14!=1
replace dfs_adopt=. if MM5_1==. & MM5_2==. & MM5_3==. & MM5_4==. & MM5_5==. & MM5_6==. & MM5_7==. & MM5_8==. & MM5_9==. & MM5_10==. & MM5_11==. & MM5_12==. & MM5_13==. & MM5_14==.
la var dfs_adopt "person has ever used DFS for any financial activity (MM5_2-14)"
...
replace dfs_lastuse_yest=1 if MM7_1==1 | MM7_2==1 | MM7_3==1 | MM7_4==1 | MM7_5==1 | MM7_6==1 | MM7_7==1 | MM7_8==1 | MM7_9==1 | MM7_10==1 | MM7_11==1 | MM7_12==1 | MM7_13==1 | MM7_14==1  
replace dfs_lastuse_yest=0 if MM7_1!=1 & MM7_2!=1 & MM7_3!=1 & MM7_4!=1 & MM7_5!=1 & MM7_6!=1 & MM7_7!=1 & MM7_8!=1 & MM7_9!=1 & MM7_10!=1 & MM7_11!=1 & MM7_12!=1 & MM7_13!=1 & MM7_14!=1
replace dfs_lastuse_yest=. if MM7_1==. & MM7_2==. & MM7_3==. & MM7_4==. & MM7_5==. & MM7_6==. & MM7_7==. & MM7_8==. & MM7_9==. & MM7_10==. & MM7_11==. & MM7_12==. & MM7_13==. & MM7_14==.
la var dfs_lastuse_yest "person used DFS yesterday (MM7_1-14)"

gen dfs_lastuse_week=.
replace dfs_lastuse_week=1 if MM7_1==2 | MM7_2==2 | MM7_3==2 | MM7_4==2 | MM7_5==2 | MM7_6==2 | MM7_7==2 | MM7_8==2 | MM7_9==2 | MM7_10==2 | MM7_11==2 | MM7_12==2 | MM7_13==2 | MM7_14==2
replace dfs_lastuse_week=0 if (MM7_1!=2 & MM7_2!=2 & MM7_3!=2 & MM7_4!=2 & MM7_5!=2 & MM7_6!=2 & MM7_7!=2 & MM7_8!=2 & MM7_9!=2 & MM7_10!=2 & MM7_11!=2 & MM7_12!=2 & MM7_13!=2 & MM7_14!=2) | dfs_lastuse_yest==1
replace dfs_lastuse_week=. if MM7_1==. & MM7_2==. & MM7_3==. & MM7_4==. & MM7_5==. & MM7_6==. & MM7_7==. & MM7_8==. & MM7_9==. & MM7_10==. & MM7_11==. & MM7_12==. & MM7_13==. & MM7_14==.
la var dfs_lastuse_week "person used DFS in the past 7 days (MM7_1-14)"

gen dfs_lastuse_month=.
replace dfs_lastuse_month=1 if MM7_1==3 | MM7_2==3 | MM7_3==3 | MM7_4==3 | MM7_5==3 | MM7_6==3 | MM7_7==3 | MM7_8==3 | MM7_9==3 | MM7_10==3 | MM7_11==3 | MM7_12==3 | MM7_13==3 | MM7_14==3
replace dfs_lastuse_month=0 if (MM7_1!=3 & MM7_2!=3 & MM7_3!=3 & MM7_4!=3 & MM7_5!=3 & MM7_6!=3 & MM7_7!=3 & MM7_8!=3 & MM7_9!=3 & MM7_10!=3 & MM7_11!=3 & MM7_12!=3 & MM7_13!=3 & MM7_14!=3) | dfs_lastuse_yest==1 | dfs_lastuse_week==1
replace dfs_lastuse_month=. if MM7_1==. & MM7_2==. & MM7_3==. & MM7_4==. & MM7_5==. & MM7_6==. & MM7_7==. & MM7_8==. & MM7_9==. & MM7_10==. & MM7_11==. & MM7_12==. & MM7_13==. & MM7_14==.
la var dfs_lastuse_month "person used DFS in the past 30 days (MM7_1-14)"

gen dfs_lastuse_90days=.
replace dfs_lastuse_90days=1 if MM7_1==4 | MM7_2==4 | MM7_3==4 | MM7_4==4 | MM7_5==4 | MM7_6==4 | MM7_7==4 | MM7_8==4 | MM7_9==4 | MM7_10==4 | MM7_11==4 | MM7_12==4 | MM7_13==4 | MM7_14==4
replace dfs_lastuse_90days=0 if (MM7_1!=4 & MM7_2!=4 & MM7_3!=4 & MM7_4!=4 & MM7_5!=4 & MM7_6!=4 & MM7_7!=4 & MM7_8!=4 & MM7_9!=4 & MM7_10!=4 & MM7_11!=4 & MM7_12!=4 & MM7_13!=4 & MM7_14!=4) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1
replace dfs_lastuse_90days=. if MM7_1==. & MM7_2==. & MM7_3==. & MM7_4==. & MM7_5==. & MM7_6==. & MM7_7==. & MM7_8==. & MM7_9==. & MM7_10==. & MM7_11==. & MM7_12==. & MM7_13==. & MM7_14==.
la var dfs_lastuse_90days "person used DFS in the past 90 days (MM7_1-14)"

gen dfs_lastuse_more90=.
replace dfs_lastuse_more90=1 if MM7_1==5 | MM7_2==5 | MM7_3==5 | MM7_4==5 | MM7_5==5 | MM7_6==5 | MM7_7==5 | MM7_8==5 | MM7_9==5 | MM7_10==5 | MM7_11==5 | MM7_12==5 | MM7_13==5 | MM7_14==5
replace dfs_lastuse_more90=0 if (MM7_1!=5 & MM7_2!=5 & MM7_3!=5 & MM7_4!=5 & MM7_5!=5 & MM7_6!=5 & MM7_7!=5 & MM7_8!=5 & MM7_9!=5 & MM7_10!=5 & MM7_11!=5 & MM7_12!=5 & MM7_13!=5 & MM7_14!=5) | dfs_lastuse_yest==1 | dfs_lastuse_week==1 | dfs_lastuse_month==1 | dfs_lastuse_90days==1
replace dfs_lastuse_more90=. if MM7_1==. & MM7_2==. & MM7_3==. & MM7_4==. & MM7_5==. & MM7_6==. & MM7_7==. & MM7_8==. & MM7_9==. & MM7_10==. & MM7_11==. & MM7_12==. & MM7_13==. & MM7_14==.
la var dfs_lastuse_more90 "person last used DFS more than 90 days ago (MM7_1-14)"
...
gen dfs_regacct=.
replace dfs_regacct=1 if MM8_1==1 | MM8_2==1 | MM8_3==1 | MM8_4==1 | MM8_5==1 | MM8_6==1 | MM8_7==1 | MM8_8==1 | MM8_9==1 | MM8_10==1 | MM8_11==1 | MM8_12==1 | MM8_13==1 | MM8_14==1
replace dfs_regacct=0 if MM8_1!=1 & MM8_2!=1 & MM8_3!=1 & MM8_4!=1 & MM8_5!=1 & MM8_6!=1 & MM8_7!=1 & MM8_8!=1 & MM8_9!=1 & MM8_10!=1 & MM8_11!=1 & MM8_12!=1 & MM8_13!=1 & MM8_14!=1
replace dfs_regacct=. if MM8_1==. & MM8_2==. & MM8_3==. & MM8_4==. & MM8_5==. & MM8_6==. & MM8_7==. & MM8_8==. & MM8_9==. & MM8_10==. & MM8_11==. & MM8_12==. & MM8_13==. & MM8_14==.
la var dfs_regacct "person has a registered account with any DFS provider (MM8_1-14)"
...
gen dfs_access_otc=.
replace dfs_access_otc=1 if MM15_1==1 | MM15_2==1 | MM15_3==1 | MM15_4==1 | MM15_5==1 | MM15_6==1 | MM15_7==1 | MM15_8==1 | MM15_9==1 | MM15_10==1 | MM15_11==1 | MM15_12==1 | MM15_13==1 | MM15_14==1
replace dfs_access_otc=0 if MM15_1!=1 & MM15_2!=1 & MM15_3!=1 & MM15_4!=1 & MM15_5!=1 & MM15_6!=1 & MM15_7!=1 & MM15_8!=1 & MM15_9!=1 & MM15_10!=1 & MM15_11!=1 & MM15_12!=1 & MM15_13!=1 & MM15_14!=1
replace dfs_access_otc=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_otc "person usually accesses DFS over the counter (MM15_1-14)"

//Account of a family member in this household
gen dfs_access_fam=.
replace dfs_access_fam=1 if MM15_1==2 | MM15_2==2 | MM15_3==2 | MM15_4==2 | MM15_5==2 | MM15_6==2 | MM15_7==2 | MM15_8==2 | MM15_9==2 | MM15_10==2 | MM15_11==2 | MM15_12==2 | MM15_13==2 | MM15_14==2
replace dfs_access_fam=0 if MM15_1!=2 & MM15_2!=2 & MM15_3!=2 & MM15_4!=2 & MM15_5!=2 & MM15_6!=2 & MM15_7!=2 & MM15_8!=2 & MM15_9!=2 & MM15_10!=2 & MM15_11!=2 & MM15_12!=2 & MM15_13!=2 & MM15_14!=2
replace dfs_access_fam=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_fam "person usually accesses DFS from a family member's acct in the hh (MM15_1-14)"

//Account of a family member in another household, other relative, friend or a neighbor
gen dfs_access_nonhh=.
replace dfs_access_nonhh=1 if MM15_1==3 | MM15_2==3 | MM15_3==3 | MM15_4==3 | MM15_5==3 | MM15_6==3 | MM15_7==3 | MM15_8==3 | MM15_9==3 | MM15_10==3 | MM15_11==3 | MM15_12==3 | MM15_13==3 | MM15_14==3
replace dfs_access_nonhh=0 if MM15_1!=3 & MM15_2!=3 & MM15_3!=3 & MM15_4!=3 & MM15_5!=3 & MM15_6!=3 & MM15_7!=3 & MM15_8!=3 & MM15_9!=3 & MM15_10!=3 & MM15_11!=3 & MM15_12!=3 & MM15_13!=3 & MM15_14!=3
replace dfs_access_nonhh=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_nonhh "person usually accesses DFS from a family member in another hh, friend, or neib (MM15_1-14)"

//Account of a workmate or a business partner
gen dfs_access_work=.
replace dfs_access_work=1 if MM15_1==4 | MM15_2==4 | MM15_3==4 | MM15_4==4 | MM15_5==4 | MM15_6==4 | MM15_7==4 | MM15_8==4 | MM15_9==4 | MM15_10==4 | MM15_11==4 | MM15_12==4 | MM15_13==4 | MM15_14==4
replace dfs_access_work=0 if MM15_1!=4 & MM15_2!=4 & MM15_3!=4 & MM15_4!=4 & MM15_5!=4 & MM15_6!=4 & MM15_7!=4 & MM15_8!=4 & MM15_9!=4 & MM15_10!=4 & MM15_11!=4 & MM15_12!=4 & MM15_13!=4 & MM15_14!=4
replace dfs_access_work=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_work "person usually accesses DFS from a workmate or business partner (MM15_1-14)"

//Their own account
gen dfs_access_ownacct=.
replace dfs_access_ownacct=1 if MM15_1==5 | MM15_2==5 | MM15_3==5 | MM15_4==5 | MM15_5==5 | MM15_6==5 | MM15_7==5 | MM15_8==5 | MM15_9==5 | MM15_10==5 | MM15_11==5 | MM15_12==5 | MM15_13==5 | MM15_14==5
replace dfs_access_ownacct=0 if MM15_1!=5 & MM15_2!=5 & MM15_3!=5 & MM15_4!=5 & MM15_5!=5 & MM15_6!=5 & MM15_7!=5 & MM15_8!=5 & MM15_9!=5 & MM15_10!=5 & MM15_11!=5 & MM15_12!=5 & MM15_13!=5 & MM15_14!=5
replace dfs_access_ownacct=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_ownacct "person usually accesses DFS from their own account (MM15_1-14)"

//Other
gen dfs_access_other=.
replace dfs_access_other=1 if MM15_1==6 | MM15_2==6 | MM15_3==6 | MM15_4==6 | MM15_5==6 | MM15_6==6 | MM15_7==6 | MM15_8==6 | MM15_9==6 | MM15_10==6 | MM15_11==6 | MM15_12==6 | MM15_13==6 | MM15_14==6
replace dfs_access_other=0 if MM15_1!=6 & MM15_2!=6 & MM15_3!=6 & MM15_4!=6 & MM15_5!=6 & MM15_6!=6 & MM15_7!=6 & MM15_8!=6 & MM15_9!=6 & MM15_10!=6 & MM15_11!=6 & MM15_12!=6 & MM15_13!=6 & MM15_14!=6
replace dfs_access_other=. if MM15_1==. & MM15_2==. & MM15_3==. & MM15_4==. & MM15_5==. & MM15_6==. & MM15_7==. & MM15_8==. & MM15_9==. & MM15_10==. & MM15_11==. & MM15_12==. & MM15_13==. & MM15_14==.
la var dfs_access_other "person usually accesses DFS in an other way (MM15_1-14)"
...
count if rec_remit==. //51 obs missing

sum rec_remit //40% of obs report receiving remittances
...
count if (TDL2_4==3 | TDL2_4==4) & TDL2_5<3 //429 people can send text messages but cannot respond to text messages from other people -- these people still have a 1 for mobileskills_text
...
count if (mobileskills_call==0 | mobileskills_text==0) & mobileskills_advanced==1 //227
*/
...
save "R:\Project\EPAR\Working Files\317 - Gender and DFS Adoption\DTAs\W2\Nigeria_W2_Clean.dta", replace
